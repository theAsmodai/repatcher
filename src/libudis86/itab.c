...
const uint16_t ud_itab__0[] = {
  ...
  /*  8 */         956,         957,         958,         959,
  /*  c */         960,         961,    GROUP(3),    GROUP(4),
  /* 10 */           5,           6,           7,           8,
  /* 14 */           9,          10,  GROUP(282),  GROUP(283),
  /* 18 */        1328,        1329,        1330,        1331,
  /* 1c */        1332,        1333,  GROUP(284),  GROUP(285),
  /* 20 */          49,          50,          51,          52,
  /* 24 */          53,          54,     INVALID,  GROUP(286),
  /* 28 */        1399,        1400,        1401,        1402,
  /* 2c */        1403,        1404,     INVALID,  GROUP(287),
  /* 30 */        1478,        1479,        1480,        1481,
  /* 34 */        1482,        1483,     INVALID,  GROUP(288),
  /* 38 */         100,         101,         102,         103,
  /* 3c */         104,         105,     INVALID,  GROUP(289),
  /* 40 */         695,         696,         697,         698,
  /* 44 */         699,         700,         701,         702,
  /* 48 */         175,         176,         177,         178,
  /* 4c */         179,         180,         181,         182,
  /* 50 */        1238,        1239,        1240,        1241,
  /* 54 */        1242,        1243,        1244,        1245,
  /* 58 */        1093,        1094,        1095,        1096,
  /* 5c */        1097,        1098,        1099,        1100,
  /* 60 */  GROUP(290),  GROUP(293),  GROUP(296),  GROUP(297),
  /* 64 */     INVALID,     INVALID,     INVALID,     INVALID,
  /* 68 */        1246,         693,        1248,         694,
  /* 6c */         705,  GROUP(298),         974,  GROUP(299),
  /* 70 */         722,         724,         726,         728,
  /* 74 */         730,         732,         734,         736,
  /* 78 */         738,         740,         742,         744,
  /* 7c */         746,         748,         750,         752,
  /* 80 */  GROUP(300),  GROUP(301),  GROUP(302),  GROUP(311),
  /* 84 */        1425,        1426,        1466,        1467,
  /* 88 */         824,         825,         826,         827,
  /* 8c */         828,         766,         829,  GROUP(312),
  /* 90 */        1468,        1469,        1470,        1471,
  /* 94 */        1472,        1473,        1474,        1475,
  /* 98 */  GROUP(313),  GROUP(314),  GROUP(315),        1461,
  /* 9c */  GROUP(316),  GROUP(320),        1302,         762,
  /* a0 */         830,         831,         832,         833,
  /* a4 */         914,  GROUP(324),         114,  GROUP(325),
  /* a8 */        1427,        1428,        1394,  GROUP(326),
  /* ac */         786,  GROUP(327),        1338,  GROUP(328),
  /* b0 */         834,         835,         836,         837,
  /* b4 */         838,         839,         840,         841,
  /* b8 */         842,         843,         844,         845,
  /* bc */         846,         847,         848,         849,
  /* c0 */  GROUP(329),  GROUP(330),        1293,        1294,
  /* c4 */  GROUP(331),  GROUP(399),  GROUP(401),  GROUP(402),
  /* c8 */         200,         772,        1295,        1296,
  /* cc */         709,         710,  GROUP(403),  GROUP(404),
  /* d0 */  GROUP(405),  GROUP(406),  GROUP(407),  GROUP(408),
  /* d4 */  GROUP(409),  GROUP(410),  GROUP(411),        1477,
  /* d8 */  GROUP(412),  GROUP(415),  GROUP(418),  GROUP(421),
  /* dc */  GROUP(424),  GROUP(427),  GROUP(430),  GROUP(433),
  /* e0 */         790,         791,         792,  GROUP(436),
  /* e4 */         686,         687,         970,         971,
  /* e8 */          72,         759,  GROUP(437),         761,
  /* ec */         688,         689,         972,         973,
  /* f0 */         785,         708,        1291,        1292,
  /* f4 */         683,          83,  GROUP(438),  GROUP(439),
  /* f8 */          77,        1387,          81,        1390,
  /* fc */          78,        1388,  GROUP(440),  GROUP(441),
};
...
static const uint16_t ud_itab__4[] = {
  ...
  /* 88 */         739,         741,         743,         745,
  /* 8c */         747,         749,         751,         753,
  /* 90 */        1342,        1343,        1344,        1345,
  /* 94 */        1346,        1347,        1348,        1349,
  /* 98 */        1350,        1351,        1352,        1353,
  /* 9c */        1354,        1355,        1356,        1357,
  /* a0 */        1237,        1092,         131,        1655,
  /* a4 */        1367,        1368,  GROUP(202),  GROUP(207),
  /* a8 */        1236,        1091,        1297,        1660,
  /* ac */        1369,        1370,  GROUP(215),         690,
  /* b0 */         122,         123,         771,        1658,
  /* b4 */         768,         769,         932,         933,
  /* b8 */  GROUP(221),     INVALID,  GROUP(222),        1656,
  /* bc */        1644,        1645,         922,         923,
  /* c0 */        1464,        1465,  GROUP(223),         896,
  /* c4 */  GROUP(224),  GROUP(225),  GROUP(226),  GROUP(227),
  /* c8 */        1646,        1647,        1648,        1649,
  /* cc */        1650,        1651,        1652,        1653,
  /* d0 */  GROUP(234),  GROUP(235),  GROUP(236),  GROUP(237),
  /* d4 */  GROUP(238),  GROUP(239),  GROUP(240),  GROUP(241),
  /* d8 */  GROUP(242),  GROUP(243),  GROUP(244),  GROUP(245),
  /* dc */  GROUP(246),  GROUP(247),  GROUP(248),  GROUP(249),
  /* e0 */  GROUP(250),  GROUP(251),  GROUP(252),  GROUP(253),
  /* e4 */  GROUP(254),  GROUP(255),  GROUP(256),  GROUP(257),
  /* e8 */  GROUP(258),  GROUP(259),  GROUP(260),  GROUP(261),
  /* ec */  GROUP(262),  GROUP(263),  GROUP(264),  GROUP(265),
  /* f0 */  GROUP(266),  GROUP(267),  GROUP(268),  GROUP(269),
  /* f4 */  GROUP(270),  GROUP(271),  GROUP(272),  GROUP(273),
  /* f8 */  GROUP(275),  GROUP(276),  GROUP(277),  GROUP(278),
  /* fc */  GROUP(279),  GROUP(280),  GROUP(281),     INVALID,
};

static const uint16_t ud_itab__5[] = {
  /*  0 */        1376,        1398,         782,         794,
  /*  4 */        1445,        1446,     INVALID,     INVALID,
};
...
static const uint16_t ud_itab__10[] = {
  /*  0 */     INVALID,        1447,     INVALID,
};

static const uint16_t ud_itab__11[] = {
  /*  0 */     INVALID,        1452,     INVALID,
};
...
static const uint16_t ud_itab__25[] = {
  /*  0 */        1417,   GROUP(26),     INVALID,     INVALID,
  /*  4 */     INVALID,     INVALID,     INVALID,     INVALID,
};

static const uint16_t ud_itab__26[] = {
  /*  0 */        1290,     INVALID,     INVALID,
};

static const uint16_t ud_itab__27[] = {
  /*  0 */        1111,        1112,        1113,        1114,
...
static const uint16_t ud_itab__28[] = {
  ...
  /* 88 */     INVALID,     INVALID,        1212,     INVALID,
  /* 8c */     INVALID,     INVALID,        1213,     INVALID,
  /* 90 */        1214,     INVALID,     INVALID,     INVALID,
  /* 94 */        1215,     INVALID,        1216,        1217,
  /* 98 */     INVALID,     INVALID,        1218,     INVALID,
  /* 9c */     INVALID,     INVALID,        1219,     INVALID,
  /* a0 */        1220,     INVALID,     INVALID,     INVALID,
  /* a4 */        1221,     INVALID,        1222,        1223,
  /* a8 */     INVALID,     INVALID,        1224,     INVALID,
  /* ac */     INVALID,     INVALID,        1225,     INVALID,
  /* b0 */        1226,     INVALID,     INVALID,     INVALID,
  /* b4 */        1227,     INVALID,        1228,        1229,
  /* b8 */     INVALID,     INVALID,     INVALID,        1230,
  /* bc */     INVALID,     INVALID,     INVALID,        1231,
...
static const uint16_t ud_itab__33[] = {
  /*  0 */         888,        1548,        1554,     INVALID,
};

static const uint16_t ud_itab__34[] = {
  /*  0 */         887,     INVALID,     INVALID,         885,
};

static const uint16_t ud_itab__35[] = {
  /*  0 */        1441,     INVALID,     INVALID,        1443,
};

static const uint16_t ud_itab__36[] = {
  /*  0 */        1439,     INVALID,     INVALID,        1437,
};
...
static const uint16_t ud_itab__38[] = {
  /*  0 */         878,     INVALID,        1552,         874,
};

static const uint16_t ud_itab__39[] = {
  /*  0 */         882,     INVALID,        1550,     INVALID,
};
...
static const uint16_t ud_itab__67[] = {
  /*  0 */        1567,     INVALID,     INVALID,        1568,
};

static const uint16_t ud_itab__68[] = {
  /*  0 */        1570,     INVALID,     INVALID,        1571,
};
...
static const uint16_t ud_itab__73[] = {
  /*  0 */     INVALID,     INVALID,     INVALID,        1606,
};

static const uint16_t ud_itab__74[] = {
  /*  0 */     INVALID,     INVALID,     INVALID,        1668,
};
...
static const uint16_t ud_itab__78[] = {
  /*  0 */        1558,     INVALID,     INVALID,        1559,
};

static const uint16_t ud_itab__79[] = {
  /*  0 */        1561,     INVALID,     INVALID,        1562,
};

static const uint16_t ud_itab__80[] = {
  /*  0 */        1564,     INVALID,     INVALID,        1565,
};

static const uint16_t ud_itab__81[] = {
  /*  0 */     INVALID,     INVALID,     INVALID,        1670,
};
...
static const uint16_t ud_itab__87[] = {
  /*  0 */     INVALID,     INVALID,     INVALID,        1607,
};
...
static const uint16_t ud_itab__89[] = {
  /*  0 */     INVALID,     INVALID,     INVALID,        1666,
};
...
static const uint16_t ud_itab__98[] = {
  /*  0 */     INVALID,     INVALID,     INVALID,        1609,
};

static const uint16_t ud_itab__99[] = {
  /*  0 */     INVALID,     INVALID,     INVALID,        1611,
};

static const uint16_t ud_itab__100[] = {
  /*  0 */     INVALID,     INVALID,     INVALID,        1613,
};

static const uint16_t ud_itab__101[] = {
  /*  0 */     INVALID,     INVALID,     INVALID,        1615,
};
...
static const uint16_t ud_itab__114[] = {
  /*  0 */        1708,        1710,     INVALID,     INVALID,
};

static const uint16_t ud_itab__115[] = {
  /*  0 */        1709,        1711,     INVALID,     INVALID,
};
...
static const uint16_t ud_itab__123[] = {
  /*  0 */     INVALID,     INVALID,     INVALID,        1662,
};
...
static const uint16_t ud_itab__125[] = {
  /*  0 */     INVALID,     INVALID,     INVALID,        1037,
};

static const uint16_t ud_itab__126[] = {
  /*  0 */     INVALID,     INVALID,     INVALID,        1048,
};
...
static const uint16_t ud_itab__130[] = {
  /*  0 */     INVALID,     INVALID,     INVALID,        1050,
};
...
static const uint16_t ud_itab__136[] = {
  /*  0 */     INVALID,     INVALID,     INVALID,        1664,
};

static const uint16_t ud_itab__137[] = {
  /*  0 */     INVALID,     INVALID,     INVALID,        1503,
};
...
static const uint16_t ud_itab__149[] = {
  /*  0 */         968,     INVALID,     INVALID,         966,
};

static const uint16_t ud_itab__150[] = {
  /*  0 */        1490,     INVALID,     INVALID,        1488,
};
...
static const uint16_t ud_itab__176[] = {
  /*  0 */         912,     INVALID,        1511,        1507,
};

static const uint16_t ud_itab__177[] = {
  /*  0 */        1126,        1525,        1523,        1527,
};
...
static const uint16_t ud_itab__179[] = {
  /*  0 */        1151,     INVALID,     INVALID,        1155,
};

static const uint16_t ud_itab__180[] = {
  /*  0 */        1144,     INVALID,     INVALID,        1142,
};

static const uint16_t ud_itab__181[] = {
  /*  0 */        1130,     INVALID,     INVALID,        1129,
};
...
static const uint16_t ud_itab__183[] = {
  /*  0 */        1157,     INVALID,     INVALID,        1161,
};

static const uint16_t ud_itab__184[] = {
  /*  0 */        1145,     INVALID,     INVALID,        1149,
};
...
static const uint16_t ud_itab__187[] = {
  /*  0 */        1163,     INVALID,     INVALID,        1167,
};

static const uint16_t ud_itab__188[] = {
  /*  0 */     INVALID,     INVALID,     INVALID,        1531,
};
...
static const uint16_t ud_itab__190[] = {
  /*  0 */     INVALID,     INVALID,     INVALID,        1529,
};

static const uint16_t ud_itab__191[] = {
  /*  0 */        1019,     INVALID,     INVALID,        1020,
};

static const uint16_t ud_itab__192[] = {
  /*  0 */        1022,     INVALID,     INVALID,        1023,
};

static const uint16_t ud_itab__193[] = {
  /*  0 */        1025,     INVALID,     INVALID,        1026,
};
...
static const uint16_t ud_itab__196[] = {
  /*  0 */     INVALID,        1538,     INVALID,        1536,
};

static const uint16_t ud_itab__197[] = {
  /*  0 */     INVALID,        1542,     INVALID,        1540,
};

static const uint16_t ud_itab__198[] = {
  /*  0 */  GROUP(199),     INVALID,         908,  GROUP(200),
};
...
static const uint16_t ud_itab__210[] = {
  /*  0 */        1492,     INVALID,     INVALID,     INVALID,
  /*  4 */     INVALID,     INVALID,     INVALID,     INVALID,
};

static const uint16_t ud_itab__211[] = {
  /*  0 */        1493,     INVALID,     INVALID,     INVALID,
  /*  4 */     INVALID,     INVALID,     INVALID,     INVALID,
};

static const uint16_t ud_itab__212[] = {
  /*  0 */        1494,     INVALID,     INVALID,     INVALID,
  /*  4 */     INVALID,     INVALID,     INVALID,     INVALID,
};

static const uint16_t ud_itab__213[] = {
  /*  0 */        1495,     INVALID,     INVALID,     INVALID,
  /*  4 */     INVALID,     INVALID,     INVALID,     INVALID,
};

static const uint16_t ud_itab__214[] = {
  /*  0 */        1496,     INVALID,     INVALID,     INVALID,
  /*  4 */     INVALID,     INVALID,     INVALID,     INVALID,
};
...
static const uint16_t ud_itab__224[] = {
  /*  0 */        1051,     INVALID,     INVALID,        1052,
};

static const uint16_t ud_itab__225[] = {
  /*  0 */        1047,     INVALID,     INVALID,        1045,
};

static const uint16_t ud_itab__226[] = {
  /*  0 */        1373,     INVALID,     INVALID,        1371,
};

static const uint16_t ud_itab__227[] = {
  /*  0 */     INVALID,  GROUP(228),     INVALID,     INVALID,
  /*  4 */     INVALID,     INVALID,  GROUP(229),  GROUP(233),
};
...
static const uint16_t ud_itab__229[] = {
  /*  0 */  GROUP(230),     INVALID,  GROUP(231),  GROUP(232),
};

static const uint16_t ud_itab__230[] = {
  /*  0 */     INVALID,        1450,     INVALID,
};

static const uint16_t ud_itab__231[] = {
  /*  0 */     INVALID,        1449,     INVALID,
};

static const uint16_t ud_itab__232[] = {
  /*  0 */     INVALID,        1448,     INVALID,
};
...
static const uint16_t ud_itab__248[] = {
  /*  0 */        1067,     INVALID,     INVALID,        1068,
};

static const uint16_t ud_itab__249[] = {
  /*  0 */        1012,     INVALID,     INVALID,        1010,
};

static const uint16_t ud_itab__250[] = {
  /*  0 */        1015,     INVALID,     INVALID,        1013,
};

static const uint16_t ud_itab__251[] = {
  /*  0 */        1139,     INVALID,     INVALID,        1140,
};
...
static const uint16_t ud_itab__264[] = {
  /*  0 */        1066,     INVALID,     INVALID,        1064,
};

static const uint16_t ud_itab__265[] = {
  /*  0 */        1258,     INVALID,     INVALID,        1256,
};

static const uint16_t ud_itab__266[] = {
  /*  0 */     INVALID,        1546,     INVALID,     INVALID,
};

static const uint16_t ud_itab__267[] = {
  /*  0 */        1128,     INVALID,     INVALID,        1127,
};
...
static const uint16_t ud_itab__270[] = {
  /*  0 */        1521,     INVALID,     INVALID,        1522,
};

static const uint16_t ud_itab__271[] = {
  /*  0 */        1061,     INVALID,     INVALID,        1062,
};

static const uint16_t ud_itab__272[] = {
  /*  0 */        1125,     INVALID,     INVALID,        1123,
};
...
static const uint16_t ud_itab__280[] = {
  /*  0 */         989,     INVALID,     INVALID,         990,
};

static const uint16_t ud_itab__281[] = {
  /*  0 */         992,     INVALID,     INVALID,         993,
};
...
static const uint16_t ud_itab__302[] = {
  /*  0 */  GROUP(303),  GROUP(304),  GROUP(305),  GROUP(306),
  /*  4 */  GROUP(307),  GROUP(308),  GROUP(309),  GROUP(310),
};
...
static const uint16_t ud_itab__312[] = {
  /*  0 */        1101,     INVALID,     INVALID,     INVALID,
  /*  4 */     INVALID,     INVALID,     INVALID,     INVALID,
};
...
static const uint16_t ud_itab__316[] = {
  /*  0 */  GROUP(317),  GROUP(318),  GROUP(319),
};
...
static const uint16_t ud_itab__320[] = {
  /*  0 */  GROUP(321),  GROUP(322),  GROUP(323),
};
...
static const uint16_t ud_itab__329[] = {
  /*  0 */        1271,        1278,        1259,        1267,
  /*  4 */        1319,        1326,        1310,        1305,
};

static const uint16_t ud_itab__330[] = {
  /*  0 */        1276,        1279,        1260,        1266,
  /*  4 */        1315,        1322,        1311,        1307,
};

static const uint16_t ud_itab__331[] = {
  /*  0 */  GROUP(332),  GROUP(333),     INVALID,     INVALID,
  /*  4 */     INVALID,  GROUP(339),  GROUP(354),  GROUP(366),
  /*  8 */     INVALID,  GROUP(391),     INVALID,     INVALID,
  /*  c */     INVALID,  GROUP(396),     INVALID,     INVALID,
};
...
static const uint16_t ud_itab__333[] = {
  ...
  /*  8 */     INVALID,     INVALID,     INVALID,     INVALID,
  /*  c */     INVALID,     INVALID,     INVALID,     INVALID,
  /* 10 */         929,         931,  GROUP(334),     INVALID,
  /* 14 */        1442,        1440,  GROUP(335),         881,
  /* 18 */     INVALID,     INVALID,     INVALID,     INVALID,
  /* 1c */     INVALID,     INVALID,     INVALID,     INVALID,
  /* 20 */     INVALID,     INVALID,     INVALID,     INVALID,
  /* 24 */     INVALID,     INVALID,     INVALID,     INVALID,
  /* 28 */         859,         861,     INVALID,         900,
  /* 2c */     INVALID,     INVALID,        1435,         130,
  /* 30 */     INVALID,     INVALID,     INVALID,     INVALID,
  /* 34 */     INVALID,     INVALID,     INVALID,     INVALID,
  /* 38 */     INVALID,     INVALID,     INVALID,     INVALID,
  /* 3c */     INVALID,     INVALID,     INVALID,     INVALID,
  ...
  /* 6c */     INVALID,     INVALID,     INVALID,     INVALID,
  /* 70 */     INVALID,     INVALID,     INVALID,     INVALID,
  /* 74 */     INVALID,     INVALID,     INVALID,  GROUP(338),
  /* 78 */     INVALID,     INVALID,     INVALID,     INVALID,
  /* 7c */     INVALID,     INVALID,     INVALID,     INVALID,
  /* 80 */     INVALID,     INVALID,     INVALID,     INVALID,
  /* 84 */     INVALID,     INVALID,     INVALID,     INVALID,
  ...
  /* a4 */     INVALID,     INVALID,     INVALID,     INVALID,
  /* a8 */     INVALID,     INVALID,     INVALID,     INVALID,
  /* ac */     INVALID,     INVALID,  GROUP(336),     INVALID,
  /* b0 */     INVALID,     INVALID,     INVALID,     INVALID,
  /* b4 */     INVALID,     INVALID,     INVALID,     INVALID,
  /* b8 */     INVALID,     INVALID,     INVALID,     INVALID,
  /* bc */     INVALID,     INVALID,     INVALID,     INVALID,
  /* c0 */     INVALID,     INVALID,         113,     INVALID,
  /* c4 */     INVALID,     INVALID,        1374,     INVALID,
  /* c8 */     INVALID,     INVALID,     INVALID,     INVALID,
  /* cc */     INVALID,     INVALID,     INVALID,     INVALID,
  /* d0 */     INVALID,     INVALID,     INVALID,     INVALID,
  /* d4 */     INVALID,     INVALID,     INVALID,     INVALID,
...
static const uint16_t ud_itab__337[] = {
  /*  0 */     INVALID,     INVALID,     INVALID,        1393,
  /*  4 */     INVALID,     INVALID,     INVALID,     INVALID,
};
...
static const uint16_t ud_itab__339[] = {
  ...
  /*  8 */     INVALID,     INVALID,     INVALID,     INVALID,
  /*  c */     INVALID,     INVALID,     INVALID,     INVALID,
  /* 10 */         925,         927,     INVALID,     INVALID,
  /* 14 */        1444,        1438,  GROUP(340),         877,
  /* 18 */     INVALID,     INVALID,     INVALID,     INVALID,
  /* 1c */     INVALID,     INVALID,     INVALID,     INVALID,
  /* 20 */     INVALID,     INVALID,     INVALID,     INVALID,
  /* 24 */     INVALID,     INVALID,     INVALID,     INVALID,
  /* 28 */         855,         857,     INVALID,         898,
  /* 2c */     INVALID,     INVALID,        1433,         128,
  /* 30 */     INVALID,     INVALID,     INVALID,     INVALID,
  /* 34 */     INVALID,     INVALID,     INVALID,     INVALID,
  /* 38 */     INVALID,     INVALID,     INVALID,     INVALID,
  /* 3c */     INVALID,     INVALID,     INVALID,     INVALID,
  ...
  /* 48 */     INVALID,     INVALID,     INVALID,     INVALID,
  /* 4c */     INVALID,     INVALID,     INVALID,     INVALID,
  /* 50 */         891,        1382,     INVALID,     INVALID,
  /* 54 */          60,          64,         967,        1489,
  /* 58 */          26,         937,         140,         144,
  /* 5c */        1410,         813,         188,         797,
  /* 60 */        1200,        1203,        1206,         978,
  /* 64 */        1029,        1032,        1035,         984,
  /* 68 */        1191,        1194,        1197,         981,
  /* 6c */     INVALID,        1534,  GROUP(341),     INVALID,
  /* 70 */        1528,  GROUP(342),  GROUP(344),  GROUP(346),
  /* 74 */        1021,        1024,        1027,     INVALID,
  /* 78 */     INVALID,     INVALID,     INVALID,     INVALID,
  /* 7c */        1537,        1541,  GROUP(348),     INVALID,
  /* 80 */     INVALID,     INVALID,     INVALID,     INVALID,
  /* 84 */     INVALID,     INVALID,     INVALID,     INVALID,
  /* 88 */     INVALID,     INVALID,     INVALID,     INVALID,
  /* 8c */     INVALID,     INVALID,     INVALID,     INVALID,
  ...
  /* c4 */        1053,        1046,        1372,     INVALID,
  /* c8 */     INVALID,     INVALID,     INVALID,     INVALID,
  /* cc */     INVALID,     INVALID,     INVALID,     INVALID,
  /* d0 */          34,        1154,        1160,        1166,
  /* d4 */        1517,        1087,         911,  GROUP(349),
  /* d8 */        1186,        1189,        1074,        1008,
  /* dc */        1003,        1006,        1069,        1011,
  /* e0 */        1014,        1141,        1147,        1017,
  /* e4 */        1081,        1083,         161,         895,
  /* e8 */        1180,        1183,        1071,        1109,
  /* ec */         997,        1000,        1065,        1257,
  /* f0 */     INVALID,  GROUP(350),  GROUP(351),  GROUP(352),
  /* f4 */     INVALID,        1063,        1124,  GROUP(353),
  /* f8 */        1170,        1173,        1177,        1519,
  /* fc */         987,         991,         994,     INVALID,
};
...
static const uint16_t ud_itab__342[] = {
  /*  0 */     INVALID,     INVALID,        1156,     INVALID,
  /*  4 */        1143,     INVALID,  GROUP(343),     INVALID,
};
...
static const uint16_t ud_itab__344[] = {
  /*  0 */     INVALID,     INVALID,        1162,     INVALID,
  /*  4 */        1150,     INVALID,  GROUP(345),     INVALID,
};
...
static const uint16_t ud_itab__346[] = {
  /*  0 */     INVALID,     INVALID,        1168,        1532,
  /*  4 */     INVALID,     INVALID,  GROUP(347),        1530,
};
...
static const uint16_t ud_itab__354[] = {
  /*  0 */        1569,        1572,        1575,        1578,
  /*  4 */        1581,        1584,        1587,        1590,
  /*  8 */        1593,        1599,        1596,        1602,
  /*  c */  GROUP(355),  GROUP(356),  GROUP(357),  GROUP(358),
  /* 10 */     INVALID,     INVALID,     INVALID,     INVALID,
  /* 14 */     INVALID,     INVALID,     INVALID,        1697,
  /* 18 */  GROUP(359),  GROUP(360),     INVALID,     INVALID,
  /* 1c */        1560,        1563,        1566,     INVALID,
  /* 20 */        1671,        1673,        1675,        1677,
  /* 24 */        1679,     INVALID,     INVALID,     INVALID,
  /* 28 */        1608,        1694,        1667,        1669,
  /* 2c */  GROUP(362),  GROUP(363),  GROUP(364),  GROUP(365),
  /* 30 */        1682,        1684,        1686,        1688,
  /* 34 */        1690,        1692,     INVALID,        1703,
  /* 38 */        1610,        1612,        1614,        1616,
  /* 3c */        1618,        1620,        1624,        1622,
  /* 40 */        1626,        1628,     INVALID,     INVALID,
  /* 44 */     INVALID,     INVALID,     INVALID,     INVALID,
  /* 48 */     INVALID,     INVALID,     INVALID,     INVALID,
  /* 4c */     INVALID,     INVALID,     INVALID,     INVALID,
  /* 50 */     INVALID,     INVALID,     INVALID,     INVALID,
...
static const uint16_t ud_itab__366[] = {
  /*  0 */     INVALID,     INVALID,     INVALID,     INVALID,
  /*  4 */  GROUP(367),  GROUP(368),  GROUP(369),     INVALID,
  /*  8 */        1630,        1632,        1634,        1636,
  /*  c */        1640,        1638,        1663,        1605,
  /* 10 */     INVALID,     INVALID,     INVALID,     INVALID,
  /* 14 */  GROUP(371),        1049,  GROUP(372),         202,
  /* 18 */  GROUP(376),  GROUP(378),     INVALID,     INVALID,
  /* 1c */     INVALID,     INVALID,     INVALID,     INVALID,
  /* 20 */  GROUP(380),        1545,  GROUP(382),     INVALID,
  /* 24 */     INVALID,     INVALID,     INVALID,     INVALID,
  /* 28 */     INVALID,     INVALID,     INVALID,     INVALID,
  /* 2c */     INVALID,     INVALID,     INVALID,     INVALID,
  /* 30 */     INVALID,     INVALID,     INVALID,     INVALID,
  ...
  /* 38 */     INVALID,     INVALID,     INVALID,     INVALID,
  /* 3c */     INVALID,     INVALID,     INVALID,     INVALID,
  /* 40 */         198,         196,        1665,     INVALID,
  /* 44 */        1504,     INVALID,     INVALID,     INVALID,
  /* 48 */     INVALID,     INVALID,  GROUP(388),  GROUP(389),
  /* 4c */  GROUP(390),     INVALID,     INVALID,     INVALID,
  /* 50 */     INVALID,     INVALID,     INVALID,     INVALID,
  /* 54 */     INVALID,     INVALID,     INVALID,     INVALID,
  /* 58 */     INVALID,     INVALID,     INVALID,     INVALID,
  /* 5c */     INVALID,     INVALID,     INVALID,     INVALID,
  /* 60 */        1701,        1699,        1707,        1705,
  /* 64 */     INVALID,     INVALID,     INVALID,     INVALID,
  /* 68 */     INVALID,     INVALID,     INVALID,     INVALID,
  /* 6c */     INVALID,     INVALID,     INVALID,     INVALID,
  /* 70 */     INVALID,     INVALID,     INVALID,     INVALID,
...
static const uint16_t ud_itab__372[] = {
  /*  0 */  GROUP(373),  GROUP(374),  GROUP(375),
};
...
static const uint16_t ud_itab__391[] = {
  ...
  /*  8 */     INVALID,     INVALID,     INVALID,     INVALID,
  /*  c */     INVALID,     INVALID,     INVALID,     INVALID,
  /* 10 */  GROUP(392),  GROUP(393),  GROUP(394),     INVALID,
  /* 14 */     INVALID,     INVALID,  GROUP(395),     INVALID,
  /* 18 */     INVALID,     INVALID,     INVALID,     INVALID,
  /* 1c */     INVALID,     INVALID,     INVALID,     INVALID,
  /* 20 */     INVALID,     INVALID,     INVALID,     INVALID,
  /* 24 */     INVALID,     INVALID,     INVALID,     INVALID,
  ...
  /* 64 */     INVALID,     INVALID,     INVALID,     INVALID,
  /* 68 */     INVALID,     INVALID,     INVALID,     INVALID,
  /* 6c */     INVALID,     INVALID,     INVALID,        1512,
  /* 70 */        1524,     INVALID,     INVALID,     INVALID,
  /* 74 */     INVALID,     INVALID,     INVALID,     INVALID,
  /* 78 */     INVALID,     INVALID,     INVALID,     INVALID,
  /* 7c */     INVALID,     INVALID,         909,     INVALID,
  /* 80 */     INVALID,     INVALID,     INVALID,     INVALID,
  /* 84 */     INVALID,     INVALID,     INVALID,     INVALID,
  /* 88 */     INVALID,     INVALID,     INVALID,     INVALID,
  /* 8c */     INVALID,     INVALID,     INVALID,     INVALID,
...
static const uint16_t ud_itab__396[] = {
  ...
  /*  8 */     INVALID,     INVALID,     INVALID,     INVALID,
  /*  c */     INVALID,     INVALID,     INVALID,     INVALID,
  /* 10 */  GROUP(398),  GROUP(397),     INVALID,     INVALID,
  /* 14 */     INVALID,     INVALID,     INVALID,     INVALID,
  /* 18 */     INVALID,     INVALID,     INVALID,     INVALID,
  /* 1c */     INVALID,     INVALID,     INVALID,     INVALID,
  /* 20 */     INVALID,     INVALID,     INVALID,     INVALID,
  ...
  /* 48 */     INVALID,     INVALID,     INVALID,     INVALID,
  /* 4c */     INVALID,     INVALID,     INVALID,     INVALID,
  /* 50 */     INVALID,        1384,     INVALID,     INVALID,
  /* 54 */     INVALID,     INVALID,     INVALID,     INVALID,
  /* 58 */          30,         941,         151,     INVALID,
  /* 5c */        1414,         817,         192,         801,
  /* 60 */     INVALID,     INVALID,     INVALID,     INVALID,
  /* 64 */     INVALID,     INVALID,     INVALID,     INVALID,
  /* 68 */     INVALID,     INVALID,     INVALID,     INVALID,
  /* 6c */     INVALID,     INVALID,     INVALID,     INVALID,
  /* 70 */        1526,     INVALID,     INVALID,     INVALID,
  /* 74 */     INVALID,     INVALID,     INVALID,     INVALID,
  /* 78 */     INVALID,     INVALID,     INVALID,     INVALID,
  /* 7c */        1539,        1543,     INVALID,     INVALID,
  /* 80 */     INVALID,     INVALID,     INVALID,     INVALID,
  /* 84 */     INVALID,     INVALID,     INVALID,     INVALID,
  /* 88 */     INVALID,     INVALID,     INVALID,     INVALID,
  /* 8c */     INVALID,     INVALID,     INVALID,     INVALID,
  ...
  /* e8 */     INVALID,     INVALID,     INVALID,     INVALID,
  /* ec */     INVALID,     INVALID,     INVALID,     INVALID,
  /* f0 */        1547,     INVALID,     INVALID,     INVALID,
  /* f4 */     INVALID,     INVALID,     INVALID,     INVALID,
  /* f8 */     INVALID,     INVALID,     INVALID,     INVALID,
  /* fc */     INVALID,     INVALID,     INVALID,     INVALID,
};
...
static const uint16_t ud_itab__399[] = {
  /*  0 */  GROUP(400),  GROUP(333),     INVALID,     INVALID,
  /*  4 */     INVALID,  GROUP(339),  GROUP(354),  GROUP(366),
  /*  8 */     INVALID,  GROUP(391),     INVALID,     INVALID,
  /*  c */     INVALID,  GROUP(396),     INVALID,     INVALID,
};
...
static const uint16_t ud_itab__405[] = {
  /*  0 */        1272,        1277,        1261,        1265,
  /*  4 */        1318,        1325,        1312,        1306,
};

static const uint16_t ud_itab__406[] = {
  /*  0 */        1273,        1280,        1264,        1268,
  /*  4 */        1317,        1324,        1321,        1304,
};

static const uint16_t ud_itab__407[] = {
  /*  0 */        1274,        1281,        1262,        1269,
  /*  4 */        1316,        1323,        1313,        1308,
};

static const uint16_t ud_itab__408[] = {
  /*  0 */        1275,        1282,        1263,        1270,
  /*  4 */        1320,        1327,        1314,        1309,
};
...
static const uint16_t ud_itab__441[] = {
  /*  0 */         703,         184,  GROUP(442),          71,
  /*  4 */         757,         758,        1247,     INVALID,
};
...
struct ud_lookup_table_list_entry ud_lookup_table_list[] = {
    ...
    /* 227 */ { ud_itab__227, UD_TAB__OPC_REG, "/reg" },
    /* 228 */ { ud_itab__228, UD_TAB__OPC_OSIZE, "/o" },
    /* 229 */ { ud_itab__229, UD_TAB__OPC_SSE, "/sse" },
    /* 230 */ { ud_itab__230, UD_TAB__OPC_VENDOR, "/vendor" },
    ...
    /* 273 */ { ud_itab__273, UD_TAB__OPC_MOD, "/mod" },
    ...
    /* 282 */ { ud_itab__282, UD_TAB__OPC_MODE, "/m" },
    /* 283 */ { ud_itab__283, UD_TAB__OPC_MODE, "/m" },
    ...
    /* 290 */ { ud_itab__290, UD_TAB__OPC_OSIZE, "/o" },
    /* 291 */ { ud_itab__291, UD_TAB__OPC_MODE, "/m" },
    /* 292 */ { ud_itab__292, UD_TAB__OPC_MODE, "/m" },
    /* 293 */ { ud_itab__293, UD_TAB__OPC_OSIZE, "/o" },
    /* 294 */ { ud_itab__294, UD_TAB__OPC_MODE, "/m" },
    /* 295 */ { ud_itab__295, UD_TAB__OPC_MODE, "/m" },
    /* 296 */ { ud_itab__296, UD_TAB__OPC_MODE, "/m" },
    /* 297 */ { ud_itab__297, UD_TAB__OPC_MODE, "/m" },
    /* 298 */ { ud_itab__298, UD_TAB__OPC_OSIZE, "/o" },
    /* 299 */ { ud_itab__299, UD_TAB__OPC_OSIZE, "/o" },
    /* 300 */ { ud_itab__300, UD_TAB__OPC_REG, "/reg" },
    /* 301 */ { ud_itab__301, UD_TAB__OPC_REG, "/reg" },
    /* 302 */ { ud_itab__302, UD_TAB__OPC_REG, "/reg" },
    /* 303 */ { ud_itab__303, UD_TAB__OPC_MODE, "/m" },
    /* 304 */ { ud_itab__304, UD_TAB__OPC_MODE, "/m" },
    ...
    /* 311 */ { ud_itab__311, UD_TAB__OPC_REG, "/reg" },
    /* 312 */ { ud_itab__312, UD_TAB__OPC_REG, "/reg" },
    /* 313 */ { ud_itab__313, UD_TAB__OPC_OSIZE, "/o" },
    /* 314 */ { ud_itab__314, UD_TAB__OPC_OSIZE, "/o" },
    /* 315 */ { ud_itab__315, UD_TAB__OPC_MODE, "/m" },
    /* 316 */ { ud_itab__316, UD_TAB__OPC_OSIZE, "/o" },
    /* 317 */ { ud_itab__317, UD_TAB__OPC_MODE, "/m" },
    /* 318 */ { ud_itab__318, UD_TAB__OPC_MODE, "/m" },
    /* 319 */ { ud_itab__319, UD_TAB__OPC_MODE, "/m" },
    /* 320 */ { ud_itab__320, UD_TAB__OPC_OSIZE, "/o" },
    /* 321 */ { ud_itab__321, UD_TAB__OPC_MODE, "/m" },
    /* 322 */ { ud_itab__322, UD_TAB__OPC_MODE, "/m" },
    /* 323 */ { ud_itab__323, UD_TAB__OPC_MODE, "/m" },
    /* 324 */ { ud_itab__324, UD_TAB__OPC_OSIZE, "/o" },
    /* 325 */ { ud_itab__325, UD_TAB__OPC_OSIZE, "/o" },
    /* 326 */ { ud_itab__326, UD_TAB__OPC_OSIZE, "/o" },
    /* 327 */ { ud_itab__327, UD_TAB__OPC_OSIZE, "/o" },
    /* 328 */ { ud_itab__328, UD_TAB__OPC_OSIZE, "/o" },
    /* 329 */ { ud_itab__329, UD_TAB__OPC_REG, "/reg" },
    /* 330 */ { ud_itab__330, UD_TAB__OPC_REG, "/reg" },
    /* 331 */ { ud_itab__331, UD_TAB__OPC_VEX, "/vex" },
    /* 332 */ { ud_itab__332, UD_TAB__OPC_MODE, "/m" },
    /* 333 */ { ud_itab__333, UD_TAB__OPC_TABLE, "opctbl" },
    /* 334 */ { ud_itab__334, UD_TAB__OPC_MOD, "/mod" },
    /* 335 */ { ud_itab__335, UD_TAB__OPC_MOD, "/mod" },
    /* 336 */ { ud_itab__336, UD_TAB__OPC_MOD, "/mod" },
    /* 337 */ { ud_itab__337, UD_TAB__OPC_REG, "/reg" },
    /* 338 */ { ud_itab__338, UD_TAB__OPC_VEX_L, "/vexl" },
    /* 339 */ { ud_itab__339, UD_TAB__OPC_TABLE, "opctbl" },
    /* 340 */ { ud_itab__340, UD_TAB__OPC_MOD, "/mod" },
    /* 341 */ { ud_itab__341, UD_TAB__OPC_OSIZE, "/o" },
    /* 342 */ { ud_itab__342, UD_TAB__OPC_REG, "/reg" },
    /* 343 */ { ud_itab__343, UD_TAB__OPC_VEX_L, "/vexl" },
    /* 344 */ { ud_itab__344, UD_TAB__OPC_REG, "/reg" },
    /* 345 */ { ud_itab__345, UD_TAB__OPC_VEX_L, "/vexl" },
    /* 346 */ { ud_itab__346, UD_TAB__OPC_REG, "/reg" },
    /* 347 */ { ud_itab__347, UD_TAB__OPC_VEX_L, "/vexl" },
    /* 348 */ { ud_itab__348, UD_TAB__OPC_OSIZE, "/o" },
    /* 349 */ { ud_itab__349, UD_TAB__OPC_VEX_L, "/vexl" },
    /* 350 */ { ud_itab__350, UD_TAB__OPC_VEX_L, "/vexl" },
    /* 351 */ { ud_itab__351, UD_TAB__OPC_VEX_L, "/vexl" },
    /* 352 */ { ud_itab__352, UD_TAB__OPC_VEX_L, "/vexl" },
    /* 353 */ { ud_itab__353, UD_TAB__OPC_MOD, "/mod" },
    /* 354 */ { ud_itab__354, UD_TAB__OPC_TABLE, "opctbl" },
    /* 355 */ { ud_itab__355, UD_TAB__OPC_VEX_W, "/vexw" },
    /* 356 */ { ud_itab__356, UD_TAB__OPC_VEX_W, "/vexw" },
    ...
    /* 361 */ { ud_itab__361, UD_TAB__OPC_VEX_L, "/vexl" },
    ...
    /* 366 */ { ud_itab__366, UD_TAB__OPC_TABLE, "opctbl" },
    /* 367 */ { ud_itab__367, UD_TAB__OPC_VEX_W, "/vexw" },
    /* 368 */ { ud_itab__368, UD_TAB__OPC_VEX_W, "/vexw" },
    /* 369 */ { ud_itab__369, UD_TAB__OPC_VEX_W, "/vexw" },
    /* 370 */ { ud_itab__370, UD_TAB__OPC_VEX_L, "/vexl" },
    ...
    /* 377 */ { ud_itab__377, UD_TAB__OPC_VEX_L, "/vexl" },
    ...
    /* 382 */ { ud_itab__382, UD_TAB__OPC_MODE, "/m" },
    /* 383 */ { ud_itab__383, UD_TAB__OPC_VEX_W, "/vexw" },
    /* 384 */ { ud_itab__384, UD_TAB__OPC_VEX_L, "/vexl" },
    /* 385 */ { ud_itab__385, UD_TAB__OPC_VEX_W, "/vexw" },
    /* 386 */ { ud_itab__386, UD_TAB__OPC_VEX_L, "/vexl" },
    /* 387 */ { ud_itab__387, UD_TAB__OPC_VEX_L, "/vexl" },
    /* 388 */ { ud_itab__388, UD_TAB__OPC_VEX_W, "/vexw" },
    /* 389 */ { ud_itab__389, UD_TAB__OPC_VEX_W, "/vexw" },
    /* 390 */ { ud_itab__390, UD_TAB__OPC_VEX_W, "/vexw" },
    /* 391 */ { ud_itab__391, UD_TAB__OPC_TABLE, "opctbl" },
    /* 392 */ { ud_itab__392, UD_TAB__OPC_MOD, "/mod" },
    /* 393 */ { ud_itab__393, UD_TAB__OPC_MOD, "/mod" },
    /* 394 */ { ud_itab__394, UD_TAB__OPC_MOD, "/mod" },
    /* 395 */ { ud_itab__395, UD_TAB__OPC_MOD, "/mod" },
    /* 396 */ { ud_itab__396, UD_TAB__OPC_TABLE, "opctbl" },
    /* 397 */ { ud_itab__397, UD_TAB__OPC_MOD, "/mod" },
    /* 398 */ { ud_itab__398, UD_TAB__OPC_MOD, "/mod" },
    /* 399 */ { ud_itab__399, UD_TAB__OPC_VEX, "/vex" },
    /* 400 */ { ud_itab__400, UD_TAB__OPC_MODE, "/m" },
    /* 401 */ { ud_itab__401, UD_TAB__OPC_REG, "/reg" },
    /* 402 */ { ud_itab__402, UD_TAB__OPC_REG, "/reg" },
    /* 403 */ { ud_itab__403, UD_TAB__OPC_MODE, "/m" },
    /* 404 */ { ud_itab__404, UD_TAB__OPC_OSIZE, "/o" },
    /* 405 */ { ud_itab__405, UD_TAB__OPC_REG, "/reg" },
    /* 406 */ { ud_itab__406, UD_TAB__OPC_REG, "/reg" },
    /* 407 */ { ud_itab__407, UD_TAB__OPC_REG, "/reg" },
    /* 408 */ { ud_itab__408, UD_TAB__OPC_REG, "/reg" },
    /* 409 */ { ud_itab__409, UD_TAB__OPC_MODE, "/m" },
    /* 410 */ { ud_itab__410, UD_TAB__OPC_MODE, "/m" },
    /* 411 */ { ud_itab__411, UD_TAB__OPC_MODE, "/m" },
    /* 412 */ { ud_itab__412, UD_TAB__OPC_MOD, "/mod" },
    /* 413 */ { ud_itab__413, UD_TAB__OPC_REG, "/reg" },
    /* 414 */ { ud_itab__414, UD_TAB__OPC_X87, "/x87" },
    /* 415 */ { ud_itab__415, UD_TAB__OPC_MOD, "/mod" },
    /* 416 */ { ud_itab__416, UD_TAB__OPC_REG, "/reg" },
    /* 417 */ { ud_itab__417, UD_TAB__OPC_X87, "/x87" },
    /* 418 */ { ud_itab__418, UD_TAB__OPC_MOD, "/mod" },
    /* 419 */ { ud_itab__419, UD_TAB__OPC_REG, "/reg" },
    /* 420 */ { ud_itab__420, UD_TAB__OPC_X87, "/x87" },
    /* 421 */ { ud_itab__421, UD_TAB__OPC_MOD, "/mod" },
    /* 422 */ { ud_itab__422, UD_TAB__OPC_REG, "/reg" },
    /* 423 */ { ud_itab__423, UD_TAB__OPC_X87, "/x87" },
    /* 424 */ { ud_itab__424, UD_TAB__OPC_MOD, "/mod" },
    /* 425 */ { ud_itab__425, UD_TAB__OPC_REG, "/reg" },
    /* 426 */ { ud_itab__426, UD_TAB__OPC_X87, "/x87" },
    /* 427 */ { ud_itab__427, UD_TAB__OPC_MOD, "/mod" },
    /* 428 */ { ud_itab__428, UD_TAB__OPC_REG, "/reg" },
    /* 429 */ { ud_itab__429, UD_TAB__OPC_X87, "/x87" },
    /* 430 */ { ud_itab__430, UD_TAB__OPC_MOD, "/mod" },
    /* 431 */ { ud_itab__431, UD_TAB__OPC_REG, "/reg" },
    /* 432 */ { ud_itab__432, UD_TAB__OPC_X87, "/x87" },
    /* 433 */ { ud_itab__433, UD_TAB__OPC_MOD, "/mod" },
    /* 434 */ { ud_itab__434, UD_TAB__OPC_REG, "/reg" },
    /* 435 */ { ud_itab__435, UD_TAB__OPC_X87, "/x87" },
    /* 436 */ { ud_itab__436, UD_TAB__OPC_ASIZE, "/a" },
    /* 437 */ { ud_itab__437, UD_TAB__OPC_MODE, "/m" },
    ...
    /* 442 */ { ud_itab__442, UD_TAB__OPC_MODE, "/m" },
};
...
struct ud_itab_entry ud_itab[] = {
  ...
  /* 0885 */ { UD_Imovlpd, O_M, O_V, O_NONE, O_NONE, P_aso|P_rexr|P_rexx|P_rexb },
  /* 0886 */ { UD_Imovlps, O_V, O_M, O_NONE, O_NONE, P_aso|P_rexr|P_rexx|P_rexb },
  /* 0887 */ { UD_Imovlps, O_M, O_V, O_NONE, O_NONE, P_aso|P_rexr|P_rexx|P_rexb },
  /* 0888 */ { UD_Imovhlps, O_V, O_U, O_NONE, O_NONE, P_aso|P_rexr|P_rexx|P_rexb },
  /* 0889 */ { UD_Ivmovhlps, O_Vx, O_Ux, O_NONE, O_NONE, P_aso|P_rexr|P_rexx|P_rexb },
  /* 0890 */ { UD_Imovmskpd, O_Gd, O_U, O_NONE, O_NONE, P_oso|P_rexr|P_rexb },
  /* 0891 */ { UD_Ivmovmskpd, O_Gd, O_Ux, O_NONE, O_NONE, P_oso|P_rexr|P_rexb|P_vexl },
  /* 0892 */ { UD_Imovmskps, O_Gd, O_U, O_NONE, O_NONE, P_oso|P_rexr|P_rexb },
  /* 0893 */ { UD_Ivmovmskps, O_Gd, O_Ux, O_NONE, O_NONE, P_oso|P_rexr|P_rexb },
  /* 0894 */ { UD_Imovntdq, O_M, O_V, O_NONE, O_NONE, P_aso|P_rexr|P_rexx|P_rexb },
  /* 0895 */ { UD_Ivmovntdq, O_M, O_Vx, O_NONE, O_NONE, P_aso|P_rexr|P_rexx|P_rexb|P_vexl },
  /* 0896 */ { UD_Imovnti, O_M, O_Gy, O_NONE, O_NONE, P_aso|P_rexw|P_rexr|P_rexx|P_rexb },
  /* 0897 */ { UD_Imovntpd, O_M, O_V, O_NONE, O_NONE, P_aso|P_rexr|P_rexx|P_rexb },
  /* 0898 */ { UD_Ivmovntpd, O_M, O_Vx, O_NONE, O_NONE, P_aso|P_rexr|P_rexx|P_rexb|P_vexl },
  /* 0899 */ { UD_Imovntps, O_M, O_V, O_NONE, O_NONE, P_aso|P_rexr|P_rexx|P_rexb },
  /* 0900 */ { UD_Ivmovntps, O_M, O_Vx, O_NONE, O_NONE, P_aso|P_rexr|P_rexx|P_rexb|P_vexl },
  /* 0901 */ { UD_Imovntq, O_M, O_P, O_NONE, O_NONE, P_aso|P_rexr|P_rexx|P_rexb },
  /* 0902 */ { UD_Imovq, O_P, O_Eq, O_NONE, O_NONE, P_aso|P_rexw|P_rexr|P_rexx|P_rexb },
  /* 0903 */ { UD_Imovq, O_V, O_Eq, O_NONE, O_NONE, P_aso|P_rexw|P_rexr|P_rexx|P_rexb },
  /* 0904 */ { UD_Ivmovq, O_Vx, O_Eq, O_NONE, O_NONE, P_aso|P_rexw|P_rexr|P_rexx|P_rexb },
  /* 0905 */ { UD_Imovq, O_Eq, O_P, O_NONE, O_NONE, P_aso|P_rexw|P_rexr|P_rexx|P_rexb },
  /* 0906 */ { UD_Imovq, O_Eq, O_V, O_NONE, O_NONE, P_aso|P_rexw|P_rexr|P_rexx|P_rexb },
  /* 0907 */ { UD_Ivmovq, O_Eq, O_Vx, O_NONE, O_NONE, P_aso|P_rexw|P_rexr|P_rexx|P_rexb },
  /* 0908 */ { UD_Imovq, O_V, O_W, O_NONE, O_NONE, P_aso|P_rexw|P_rexr|P_rexx|P_rexb },
  /* 0909 */ { UD_Ivmovq, O_Vx, O_Wx, O_NONE, O_NONE, P_aso|P_rexw|P_rexr|P_rexx|P_rexb },
  /* 0910 */ { UD_Imovq, O_W, O_V, O_NONE, O_NONE, P_aso|P_rexw|P_rexr|P_rexx|P_rexb },
  /* 0911 */ { UD_Ivmovq, O_Wx, O_Vx, O_NONE, O_NONE, P_aso|P_rexw|P_rexr|P_rexx|P_rexb },
  /* 0912 */ { UD_Imovq, O_P, O_Q, O_NONE, O_NONE, P_aso|P_rexw|P_rexr|P_rexx|P_rexb },
  /* 0913 */ { UD_Imovq, O_Q, O_P, O_NONE, O_NONE, P_aso|P_rexw|P_rexr|P_rexx|P_rexb },
  /* 0914 */ { UD_Imovsb, O_NONE, O_NONE, O_NONE, O_NONE, P_str|P_seg },
  /* 0915 */ { UD_Imovsw, O_NONE, O_NONE, O_NONE, O_NONE, P_str|P_seg|P_oso|P_rexw },
  /* 0916 */ { UD_Imovsd, O_NONE, O_NONE, O_NONE, O_NONE, P_str|P_seg|P_oso|P_rexw },
  /* 0917 */ { UD_Imovsd, O_V, O_MqU, O_NONE, O_NONE, P_aso|P_rexr|P_rexx|P_rexb },
  /* 0918 */ { UD_Imovsd, O_W, O_V, O_NONE, O_NONE, P_aso|P_rexr|P_rexx|P_rexb },
  /* 0919 */ { UD_Imovsq, O_NONE, O_NONE, O_NONE, O_NONE, P_str|P_seg|P_oso|P_rexw },
  /* 0920 */ { UD_Imovss, O_V, O_MdU, O_NONE, O_NONE, P_aso|P_rexr|P_rexx|P_rexb },
  /* 0921 */ { UD_Imovss, O_W, O_V, O_NONE, O_NONE, P_aso|P_rexr|P_rexx|P_rexb },
  /* 0922 */ { UD_Imovsx, O_Gv, O_Eb, O_NONE, O_NONE, P_aso|P_oso|P_rexw|P_rexr|P_rexx|P_rexb },
  /* 0923 */ { UD_Imovsx, O_Gy, O_Ew, O_NONE, O_NONE, P_aso|P_oso|P_rexw|P_rexr|P_rexx|P_rexb },
  /* 0924 */ { UD_Imovupd, O_V, O_W, O_NONE, O_NONE, P_aso|P_rexr|P_rexx|P_rexb },
  /* 0925 */ { UD_Ivmovupd, O_Vx, O_Wx, O_NONE, O_NONE, P_aso|P_rexr|P_rexx|P_rexb|P_vexl },
  /* 0926 */ { UD_Imovupd, O_W, O_V, O_NONE, O_NONE, P_aso|P_rexr|P_rexx|P_rexb },
  /* 0927 */ { UD_Ivmovupd, O_Wx, O_Vx, O_NONE, O_NONE, P_aso|P_rexr|P_rexx|P_rexb|P_vexl },
  /* 0928 */ { UD_Imovups, O_V, O_W, O_NONE, O_NONE, P_aso|P_rexr|P_rexx|P_rexb },
  /* 0929 */ { UD_Ivmovups, O_Vx, O_Wx, O_NONE, O_NONE, P_aso|P_rexr|P_rexx|P_rexb|P_vexl },
  /* 0930 */ { UD_Imovups, O_W, O_V, O_NONE, O_NONE, P_aso|P_rexr|P_rexx|P_rexb },
  /* 0931 */ { UD_Ivmovups, O_Wx, O_Vx, O_NONE, O_NONE, P_aso|P_rexr|P_rexx|P_rexb|P_vexl },
  /* 0932 */ { UD_Imovzx, O_Gv, O_Eb, O_NONE, O_NONE, P_aso|P_oso|P_rexw|P_rexr|P_rexx|P_rexb },
  /* 0933 */ { UD_Imovzx, O_Gy, O_Ew, O_NONE, O_NONE, P_aso|P_oso|P_rexw|P_rexr|P_rexx|P_rexb },
  /* 0934 */ { UD_Imul, O_Eb, O_NONE, O_NONE, O_NONE, P_aso|P_rexw|P_rexr|P_rexx|P_rexb },
  /* 0935 */ { UD_Imul, O_Ev, O_NONE, O_NONE, O_NONE, P_aso|P_oso|P_rexw|P_rexr|P_rexx|P_rexb },
  /* 0936 */ { UD_Imulpd, O_V, O_W, O_NONE, O_NONE, P_aso|P_rexr|P_rexx|P_rexb },
  /* 0937 */ { UD_Ivmulpd, O_Vx, O_Hx, O_Wx, O_NONE, P_aso|P_rexr|P_rexx|P_rexb|P_vexl },
  /* 0938 */ { UD_Imulps, O_V, O_W, O_NONE, O_NONE, P_aso|P_rexr|P_rexx|P_rexb },
  /* 0939 */ { UD_Ivmulps, O_Vx, O_Hx, O_Wx, O_NONE, P_aso|P_rexr|P_rexx|P_rexb|P_vexl },
  /* 0940 */ { UD_Imulsd, O_V, O_W, O_NONE, O_NONE, P_aso|P_rexr|P_rexx|P_rexb },
  /* 0941 */ { UD_Ivmulsd, O_Vx, O_Hx, O_Wx, O_NONE, P_aso|P_rexr|P_rexx|P_rexb },
  /* 0942 */ { UD_Imulss, O_V, O_W, O_NONE, O_NONE, P_aso|P_rexr|P_rexx|P_rexb },
  /* 0943 */ { UD_Ivmulss, O_Vx, O_Hx, O_Wx, O_NONE, P_aso|P_rexr|P_rexx|P_rexb },
  /* 0944 */ { UD_Imwait, O_NONE, O_NONE, O_NONE, O_NONE, P_none },
  /* 0945 */ { UD_Ineg, O_Eb, O_NONE, O_NONE, O_NONE, P_aso|P_rexw|P_rexr|P_rexx|P_rexb },
  /* 0946 */ { UD_Ineg, O_Ev, O_NONE, O_NONE, O_NONE, P_aso|P_oso|P_rexw|P_rexr|P_rexx|P_rexb },
  /* 0947 */ { UD_Inop, O_M, O_NONE, O_NONE, O_NONE, P_aso|P_rexr|P_rexx|P_rexb },
  /* 0948 */ { UD_Inop, O_M, O_NONE, O_NONE, O_NONE, P_aso|P_rexr|P_rexx|P_rexb },
  /* 0949 */ { UD_Inop, O_M, O_NONE, O_NONE, O_NONE, P_aso|P_rexr|P_rexx|P_rexb },
  /* 0950 */ { UD_Inop, O_M, O_NONE, O_NONE, O_NONE, P_aso|P_rexr|P_rexx|P_rexb },
  ...
  /* 0954 */ { UD_Inot, O_Eb, O_NONE, O_NONE, O_NONE, P_aso|P_rexw|P_rexr|P_rexx|P_rexb },
  /* 0955 */ { UD_Inot, O_Ev, O_NONE, O_NONE, O_NONE, P_aso|P_oso|P_rexw|P_rexr|P_rexx|P_rexb },
  /* 0956 */ { UD_Ior, O_Eb, O_Gb, O_NONE, O_NONE, P_aso|P_rexr|P_rexx|P_rexb },
  /* 0957 */ { UD_Ior, O_Ev, O_Gv, O_NONE, O_NONE, P_aso|P_oso|P_rexw|P_rexr|P_rexx|P_rexb },
  /* 0958 */ { UD_Ior, O_Gb, O_Eb, O_NONE, O_NONE, P_aso|P_rexr|P_rexx|P_rexb },
  /* 0959 */ { UD_Ior, O_Gv, O_Ev, O_NONE, O_NONE, P_aso|P_oso|P_rexw|P_rexr|P_rexx|P_rexb },
  /* 0960 */ { UD_Ior, O_AL, O_Ib, O_NONE, O_NONE, P_none },
  /* 0961 */ { UD_Ior, O_rAX, O_sIz, O_NONE, O_NONE, P_oso|P_rexw },
  /* 0962 */ { UD_Ior, O_Eb, O_Ib, O_NONE, O_NONE, P_aso|P_rexr|P_rexx|P_rexb },
  /* 0963 */ { UD_Ior, O_Ev, O_sIz, O_NONE, O_NONE, P_aso|P_oso|P_rexw|P_rexr|P_rexx|P_rexb },
  /* 0964 */ { UD_Ior, O_Eb, O_Ib, O_NONE, O_NONE, P_aso|P_rexr|P_rexx|P_rexb },
  /* 0965 */ { UD_Ior, O_Ev, O_sIb, O_NONE, O_NONE, P_aso|P_oso|P_rexw|P_rexr|P_rexx|P_rexb },
  /* 0966 */ { UD_Iorpd, O_V, O_W, O_NONE, O_NONE, P_aso|P_rexr|P_rexx|P_rexb },
  /* 0967 */ { UD_Ivorpd, O_Vx, O_Hx, O_Wx, O_NONE, P_aso|P_rexr|P_rexx|P_rexb|P_vexl },
  /* 0968 */ { UD_Iorps, O_V, O_W, O_NONE, O_NONE, P_aso|P_rexr|P_rexx|P_rexb },
  /* 0969 */ { UD_Ivorps, O_Vx, O_Hx, O_Wx, O_NONE, P_aso|P_rexr|P_rexx|P_rexb|P_vexl },
  /* 0970 */ { UD_Iout, O_Ib, O_AL, O_NONE, O_NONE, P_none },
  /* 0971 */ { UD_Iout, O_Ib, O_eAX, O_NONE, O_NONE, P_oso },
  /* 0972 */ { UD_Iout, O_DX, O_AL, O_NONE, O_NONE, P_none },
  /* 0973 */ { UD_Iout, O_DX, O_eAX, O_NONE, O_NONE, P_oso },
  /* 0974 */ { UD_Ioutsb, O_NONE, O_NONE, O_NONE, O_NONE, P_str|P_seg },
  /* 0975 */ { UD_Ioutsw, O_NONE, O_NONE, O_NONE, O_NONE, P_str|P_oso|P_seg },
  /* 0976 */ { UD_Ioutsd, O_NONE, O_NONE, O_NONE, O_NONE, P_str|P_oso|P_seg },
  /* 0977 */ { UD_Ipacksswb, O_V, O_W, O_NONE, O_NONE, P_aso|P_rexr|P_rexx|P_rexb },
  /* 0978 */ { UD_Ivpacksswb, O_Vx, O_Hx, O_Wx, O_NONE, P_aso|P_rexr|P_rexx|P_rexb|P_vexl },
  /* 0979 */ { UD_Ipacksswb, O_P, O_Q, O_NONE, O_NONE, P_aso|P_rexr|P_rexx|P_rexb },
  /* 0980 */ { UD_Ipackssdw, O_V, O_W, O_NONE, O_NONE, P_aso|P_rexr|P_rexx|P_rexb },
  /* 0981 */ { UD_Ivpackssdw, O_Vx, O_Hx, O_Wx, O_NONE, P_aso|P_rexr|P_rexx|P_rexb|P_vexl },
  /* 0982 */ { UD_Ipackssdw, O_P, O_Q, O_NONE, O_NONE, P_aso|P_rexr|P_rexx|P_rexb },
  /* 0983 */ { UD_Ipackuswb, O_V, O_W, O_NONE, O_NONE, P_aso|P_rexr|P_rexx|P_rexb },
  /* 0984 */ { UD_Ivpackuswb, O_Vx, O_Hx, O_Wx, O_NONE, P_aso|P_rexr|P_rexx|P_rexb|P_vexl },
  /* 0985 */ { UD_Ipackuswb, O_P, O_Q, O_NONE, O_NONE, P_aso|P_rexr|P_rexx|P_rexb },
  /* 0986 */ { UD_Ipaddb, O_V, O_W, O_NONE, O_NONE, P_aso|P_rexr|P_rexx|P_rexb },
  /* 0987 */ { UD_Ivpaddb, O_Vx, O_Hx, O_Wx, O_NONE, P_aso|P_rexr|P_rexx|P_rexb|P_vexl },
  /* 0988 */ { UD_Ipaddb, O_P, O_Q, O_NONE, O_NONE, P_aso|P_rexr|P_rexx|P_rexb },
  /* 0989 */ { UD_Ipaddw, O_P, O_Q, O_NONE, O_NONE, P_aso|P_rexr|P_rexx|P_rexb },
  /* 0990 */ { UD_Ipaddw, O_V, O_W, O_NONE, O_NONE, P_aso|P_rexr|P_rexx|P_rexb },
  /* 0991 */ { UD_Ivpaddw, O_Vx, O_Hx, O_Wx, O_NONE, P_aso|P_rexr|P_rexx|P_rexb|P_vexl },
  /* 0992 */ { UD_Ipaddd, O_P, O_Q, O_NONE, O_NONE, P_aso|P_rexr|P_rexx|P_rexb },
  /* 0993 */ { UD_Ipaddd, O_V, O_W, O_NONE, O_NONE, P_aso|P_rexr|P_rexx|P_rexb },
  /* 0994 */ { UD_Ivpaddd, O_Vx, O_Hx, O_Wx, O_NONE, P_aso|P_rexr|P_rexx|P_rexb|P_vexl },
  /* 0995 */ { UD_Ipaddsb, O_P, O_Q, O_NONE, O_NONE, P_aso|P_rexr|P_rexx|P_rexb },
  /* 0996 */ { UD_Ipaddsb, O_V, O_W, O_NONE, O_NONE, P_aso|P_rexr|P_rexx|P_rexb },
  /* 0997 */ { UD_Ivpaddsb, O_Vx, O_Hx, O_Wx, O_NONE, P_aso|P_rexr|P_rexx|P_rexb },
  /* 0998 */ { UD_Ipaddsw, O_P, O_Q, O_NONE, O_NONE, P_aso|P_rexr|P_rexx|P_rexb },
  /* 0999 */ { UD_Ipaddsw, O_V, O_W, O_NONE, O_NONE, P_aso|P_rexr|P_rexx|P_rexb },
  /* 1000 */ { UD_Ivpaddsw, O_Vx, O_Hx, O_Wx, O_NONE, P_aso|P_rexr|P_rexx|P_rexb },
  /* 1001 */ { UD_Ipaddusb, O_P, O_Q, O_NONE, O_NONE, P_aso|P_rexr|P_rexx|P_rexb },
  /* 1002 */ { UD_Ipaddusb, O_V, O_W, O_NONE, O_NONE, P_aso|P_rexr|P_rexx|P_rexb },
  /* 1003 */ { UD_Ivpaddusb, O_Vx, O_Hx, O_Wx, O_NONE, P_aso|P_rexr|P_rexx|P_rexb },
  /* 1004 */ { UD_Ipaddusw, O_P, O_Q, O_NONE, O_NONE, P_aso|P_rexr|P_rexx|P_rexb },
  /* 1005 */ { UD_Ipaddusw, O_V, O_W, O_NONE, O_NONE, P_aso|P_rexr|P_rexx|P_rexb },
  /* 1006 */ { UD_Ivpaddusw, O_Vx, O_Hx, O_Wx, O_NONE, P_aso|P_rexr|P_rexx|P_rexb },
  /* 1007 */ { UD_Ipand, O_V, O_W, O_NONE, O_NONE, P_aso|P_rexr|P_rexx|P_rexb },
  /* 1008 */ { UD_Ivpand, O_Vx, O_Hx, O_Wx, O_NONE, P_aso|P_rexr|P_rexx|P_rexb },
  /* 1009 */ { UD_Ipand, O_P, O_Q, O_NONE, O_NONE, P_aso|P_rexr|P_rexx|P_rexb },
  /* 1010 */ { UD_Ipandn, O_V, O_W, O_NONE, O_NONE, P_aso|P_rexr|P_rexx|P_rexb },
  /* 1011 */ { UD_Ivpandn, O_Vx, O_Hx, O_Wx, O_NONE, P_aso|P_rexr|P_rexx|P_rexb },
  /* 1012 */ { UD_Ipandn, O_P, O_Q, O_NONE, O_NONE, P_aso|P_rexr|P_rexx|P_rexb },
  /* 1013 */ { UD_Ipavgb, O_V, O_W, O_NONE, O_NONE, P_aso|P_rexr|P_rexx|P_rexb },
  /* 1014 */ { UD_Ivpavgb, O_Vx, O_Hx, O_Wx, O_NONE, P_aso|P_rexr|P_rexx|P_rexb },
  /* 1015 */ { UD_Ipavgb, O_P, O_Q, O_NONE, O_NONE, P_aso|P_rexr|P_rexx|P_rexb },
  /* 1016 */ { UD_Ipavgw, O_V, O_W, O_NONE, O_NONE, P_aso|P_rexr|P_rexx|P_rexb },
  /* 1017 */ { UD_Ivpavgw, O_Vx, O_Hx, O_Wx, O_NONE, P_aso|P_rexr|P_rexx|P_rexb },
  /* 1018 */ { UD_Ipavgw, O_P, O_Q, O_NONE, O_NONE, P_aso|P_rexr|P_rexx|P_rexb },
  /* 1019 */ { UD_Ipcmpeqb, O_P, O_Q, O_NONE, O_NONE, P_aso|P_rexr|P_rexx|P_rexb },
  /* 1020 */ { UD_Ipcmpeqb, O_V, O_W, O_NONE, O_NONE, P_aso|P_rexr|P_rexx|P_rexb },
  /* 1021 */ { UD_Ivpcmpeqb, O_Vx, O_Hx, O_Wx, O_NONE, P_aso|P_rexr|P_rexx|P_rexb },
  /* 1022 */ { UD_Ipcmpeqw, O_P, O_Q, O_NONE, O_NONE, P_aso|P_rexr|P_rexx|P_rexb },
  /* 1023 */ { UD_Ipcmpeqw, O_V, O_W, O_NONE, O_NONE, P_aso|P_rexr|P_rexx|P_rexb },
  /* 1024 */ { UD_Ivpcmpeqw, O_Vx, O_Hx, O_Wx, O_NONE, P_aso|P_rexr|P_rexx|P_rexb },
  /* 1025 */ { UD_Ipcmpeqd, O_P, O_Q, O_NONE, O_NONE, P_aso|P_rexr|P_rexx|P_rexb },
  /* 1026 */ { UD_Ipcmpeqd, O_V, O_W, O_NONE, O_NONE, P_aso|P_rexr|P_rexx|P_rexb },
  /* 1027 */ { UD_Ivpcmpeqd, O_Vx, O_Hx, O_Wx, O_NONE, P_aso|P_rexr|P_rexx|P_rexb },
  /* 1028 */ { UD_Ipcmpgtb, O_V, O_W, O_NONE, O_NONE, P_aso|P_rexr|P_rexx|P_rexb },
  /* 1029 */ { UD_Ivpcmpgtb, O_Vx, O_Hx, O_Wx, O_NONE, P_aso|P_rexr|P_rexx|P_rexb },
  /* 1030 */ { UD_Ipcmpgtb, O_P, O_Q, O_NONE, O_NONE, P_aso|P_rexr|P_rexx|P_rexb },
  /* 1031 */ { UD_Ipcmpgtw, O_V, O_W, O_NONE, O_NONE, P_aso|P_rexr|P_rexx|P_rexb },
  /* 1032 */ { UD_Ivpcmpgtw, O_Vx, O_Hx, O_Wx, O_NONE, P_aso|P_rexr|P_rexx|P_rexb },
  /* 1033 */ { UD_Ipcmpgtw, O_P, O_Q, O_NONE, O_NONE, P_aso|P_rexr|P_rexx|P_rexb },
  /* 1034 */ { UD_Ipcmpgtd, O_V, O_W, O_NONE, O_NONE, P_aso|P_rexr|P_rexx|P_rexb },
  /* 1035 */ { UD_Ivpcmpgtd, O_Vx, O_Hx, O_Wx, O_NONE, P_aso|P_rexr|P_rexx|P_rexb },
  /* 1036 */ { UD_Ipcmpgtd, O_P, O_Q, O_NONE, O_NONE, P_aso|P_rexr|P_rexx|P_rexb },
  /* 1037 */ { UD_Ipextrb, O_MbRv, O_V, O_Ib, O_NONE, P_aso|P_rexx|P_rexr|P_rexb|P_def64 },
  /* 1038 */ { UD_Ivpextrb, O_MbRv, O_Vx, O_Ib, O_NONE, P_aso|P_rexx|P_rexr|P_rexb|P_def64 },
  /* 1039 */ { UD_Ipextrd, O_Ed, O_V, O_Ib, O_NONE, P_aso|P_rexr|P_rexx|P_rexw|P_rexb },
  /* 1040 */ { UD_Ivpextrd, O_Ed, O_Vx, O_Ib, O_NONE, P_aso|P_rexr|P_rexx|P_rexw|P_rexb },
  /* 1041 */ { UD_Ipextrd, O_Ed, O_V, O_Ib, O_NONE, P_aso|P_rexr|P_rexx|P_rexw|P_rexb },
  /* 1042 */ { UD_Ivpextrd, O_Ed, O_Vx, O_Ib, O_NONE, P_aso|P_rexr|P_rexx|P_rexw|P_rexb },
  /* 1043 */ { UD_Ipextrq, O_Eq, O_V, O_Ib, O_NONE, P_aso|P_rexr|P_rexw|P_rexb|P_def64 },
  /* 1044 */ { UD_Ivpextrq, O_Eq, O_Vx, O_Ib, O_NONE, P_aso|P_rexr|P_rexw|P_rexb|P_def64 },
  /* 1045 */ { UD_Ipextrw, O_Gy, O_U, O_Ib, O_NONE, P_aso|P_rexw|P_rexr|P_rexb },
  /* 1046 */ { UD_Ivpextrw, O_Gy, O_Ux, O_Ib, O_NONE, P_aso|P_rexw|P_rexr|P_rexb },
  /* 1047 */ { UD_Ipextrw, O_Gy, O_N, O_Ib, O_NONE, P_aso|P_oso|P_rexw|P_rexr|P_rexx|P_rexb },
  /* 1048 */ { UD_Ipextrw, O_MwRv, O_V, O_Ib, O_NONE, P_aso|P_rexx|P_rexr|P_rexb },
  /* 1049 */ { UD_Ivpextrw, O_MwRv, O_Vx, O_Ib, O_NONE, P_aso|P_rexx|P_rexr|P_rexb },
  /* 1050 */ { UD_Ipinsrb, O_V, O_MbRd, O_Ib, O_NONE, P_aso|P_rexw|P_rexr|P_rexx|P_rexb },
  /* 1051 */ { UD_Ipinsrw, O_P, O_MwRy, O_Ib, O_NONE, P_aso|P_rexw|P_rexr|P_rexx|P_rexb|P_def64 },
  /* 1052 */ { UD_Ipinsrw, O_V, O_MwRy, O_Ib, O_NONE, P_aso|P_rexw|P_rexr|P_rexx|P_rexb|P_def64 },
  /* 1053 */ { UD_Ivpinsrw, O_Vx, O_MwRy, O_Ib, O_NONE, P_aso|P_rexw|P_rexr|P_rexx|P_rexb|P_def64 },
  /* 1054 */ { UD_Ipinsrd, O_V, O_Ed, O_Ib, O_NONE, P_aso|P_rexw|P_rexr|P_rexx|P_rexb },
  /* 1055 */ { UD_Ipinsrd, O_V, O_Ed, O_Ib, O_NONE, P_aso|P_rexw|P_rexr|P_rexx|P_rexb },
  /* 1056 */ { UD_Ipinsrq, O_V, O_Eq, O_Ib, O_NONE, P_aso|P_oso|P_rexw|P_rexr|P_rexx|P_rexb },
  /* 1057 */ { UD_Ivpinsrb, O_V, O_H, O_MbRd, O_Ib, P_aso|P_rexw|P_rexr|P_rexx|P_rexb },
  /* 1058 */ { UD_Ivpinsrd, O_V, O_H, O_Ed, O_Ib, P_aso|P_oso|P_rexw|P_rexr|P_rexx|P_rexb },
  /* 1059 */ { UD_Ivpinsrd, O_V, O_H, O_Ed, O_Ib, P_aso|P_oso|P_rexw|P_rexr|P_rexx|P_rexb },
  /* 1060 */ { UD_Ivpinsrq, O_V, O_H, O_Eq, O_Ib, P_aso|P_oso|P_rexw|P_rexr|P_rexx|P_rexb },
  /* 1061 */ { UD_Ipmaddwd, O_P, O_Q, O_NONE, O_NONE, P_aso|P_rexr|P_rexx|P_rexb },
  /* 1062 */ { UD_Ipmaddwd, O_V, O_W, O_NONE, O_NONE, P_aso|P_rexr|P_rexx|P_rexb },
  /* 1063 */ { UD_Ivpmaddwd, O_Vx, O_Hx, O_Wx, O_NONE, P_aso|P_rexr|P_rexx|P_rexb },
  /* 1064 */ { UD_Ipmaxsw, O_V, O_W, O_NONE, O_NONE, P_aso|P_rexr|P_rexx|P_rexb },
  /* 1065 */ { UD_Ivpmaxsw, O_Vx, O_Hx, O_Wx, O_NONE, P_aso|P_rexr|P_rexx|P_rexb },
  /* 1066 */ { UD_Ipmaxsw, O_P, O_Q, O_NONE, O_NONE, P_aso|P_rexr|P_rexx|P_rexb },
  /* 1067 */ { UD_Ipmaxub, O_P, O_Q, O_NONE, O_NONE, P_aso|P_rexr|P_rexx|P_rexb },
  /* 1068 */ { UD_Ipmaxub, O_V, O_W, O_NONE, O_NONE, P_aso|P_rexr|P_rexx|P_rexb },
  /* 1069 */ { UD_Ivpmaxub, O_Vx, O_Hx, O_Wx, O_NONE, P_aso|P_rexr|P_rexx|P_rexb },
  /* 1070 */ { UD_Ipminsw, O_V, O_W, O_NONE, O_NONE, P_aso|P_rexr|P_rexx|P_rexb },
  /* 1071 */ { UD_Ivpminsw, O_Vx, O_Hx, O_Wx, O_NONE, P_aso|P_rexr|P_rexx|P_rexb },
  /* 1072 */ { UD_Ipminsw, O_P, O_Q, O_NONE, O_NONE, P_aso|P_rexr|P_rexx|P_rexb },
  /* 1073 */ { UD_Ipminub, O_V, O_W, O_NONE, O_NONE, P_aso|P_rexr|P_rexx|P_rexb },
  /* 1074 */ { UD_Ivpminub, O_Vx, O_Hx, O_Wx, O_NONE, P_aso|P_rexr|P_rexx|P_rexb },
  /* 1075 */ { UD_Ipminub, O_P, O_Q, O_NONE, O_NONE, P_aso|P_rexr|P_rexx|P_rexb },
  /* 1076 */ { UD_Ipmovmskb, O_Gd, O_U, O_NONE, O_NONE, P_oso|P_rexr|P_rexw|P_rexb },
  /* 1077 */ { UD_Ivpmovmskb, O_Gd, O_Ux, O_NONE, O_NONE, P_oso|P_rexr|P_rexw|P_rexb },
  /* 1078 */ { UD_Ipmovmskb, O_Gd, O_N, O_NONE, O_NONE, P_oso|P_rexr|P_rexw|P_rexb },
  /* 1079 */ { UD_Ipmulhuw, O_P, O_Q, O_NONE, O_NONE, P_aso|P_rexr|P_rexx|P_rexb },
  /* 1080 */ { UD_Ipmulhuw, O_V, O_W, O_NONE, O_NONE, P_aso|P_rexr|P_rexx|P_rexb },
  /* 1081 */ { UD_Ivpmulhuw, O_Vx, O_Hx, O_Wx, O_NONE, P_aso|P_rexr|P_rexx|P_rexb },
  /* 1082 */ { UD_Ipmulhw, O_V, O_W, O_NONE, O_NONE, P_aso|P_rexr|P_rexx|P_rexb },
  /* 1083 */ { UD_Ivpmulhw, O_Vx, O_Hx, O_Wx, O_NONE, P_aso|P_rexr|P_rexx|P_rexb },
  /* 1084 */ { UD_Ipmulhw, O_P, O_Q, O_NONE, O_NONE, P_aso|P_rexr|P_rexx|P_rexb },
  /* 1085 */ { UD_Ipmullw, O_P, O_Q, O_NONE, O_NONE, P_aso|P_rexr|P_rexx|P_rexb },
  /* 1086 */ { UD_Ipmullw, O_V, O_W, O_NONE, O_NONE, P_aso|P_rexr|P_rexx|P_rexb },
  /* 1087 */ { UD_Ivpmullw, O_Vx, O_Hx, O_Wx, O_NONE, P_aso|P_rexr|P_rexx|P_rexb },
  /* 1088 */ { UD_Ipop, O_ES, O_NONE, O_NONE, O_NONE, P_inv64 },
  /* 1089 */ { UD_Ipop, O_SS, O_NONE, O_NONE, O_NONE, P_inv64 },
  /* 1090 */ { UD_Ipop, O_DS, O_NONE, O_NONE, O_NONE, P_inv64 },
  /* 1091 */ { UD_Ipop, O_GS, O_NONE, O_NONE, O_NONE, P_none },
  /* 1092 */ { UD_Ipop, O_FS, O_NONE, O_NONE, O_NONE, P_none },
  /* 1093 */ { UD_Ipop, O_R0v, O_NONE, O_NONE, O_NONE, P_oso|P_rexb|P_def64 },
  /* 1094 */ { UD_Ipop, O_R1v, O_NONE, O_NONE, O_NONE, P_oso|P_rexb|P_def64 },
  /* 1095 */ { UD_Ipop, O_R2v, O_NONE, O_NONE, O_NONE, P_oso|P_rexb|P_def64 },
  /* 1096 */ { UD_Ipop, O_R3v, O_NONE, O_NONE, O_NONE, P_oso|P_rexb|P_def64 },
  /* 1097 */ { UD_Ipop, O_R4v, O_NONE, O_NONE, O_NONE, P_oso|P_rexb|P_def64 },
  /* 1098 */ { UD_Ipop, O_R5v, O_NONE, O_NONE, O_NONE, P_oso|P_rexb|P_def64 },
  /* 1099 */ { UD_Ipop, O_R6v, O_NONE, O_NONE, O_NONE, P_oso|P_rexb|P_def64 },
  /* 1100 */ { UD_Ipop, O_R7v, O_NONE, O_NONE, O_NONE, P_oso|P_rexb|P_def64 },
  /* 1101 */ { UD_Ipop, O_Ev, O_NONE, O_NONE, O_NONE, P_aso|P_oso|P_rexw|P_rexr|P_rexx|P_rexb|P_def64 },
  /* 1102 */ { UD_Ipopa, O_NONE, O_NONE, O_NONE, O_NONE, P_oso|P_inv64 },
  /* 1103 */ { UD_Ipopad, O_NONE, O_NONE, O_NONE, O_NONE, P_oso|P_inv64 },
  /* 1104 */ { UD_Ipopfw, O_NONE, O_NONE, O_NONE, O_NONE, P_oso },
  /* 1105 */ { UD_Ipopfd, O_NONE, O_NONE, O_NONE, O_NONE, P_oso },
  /* 1106 */ { UD_Ipopfq, O_NONE, O_NONE, O_NONE, O_NONE, P_oso|P_def64 },
  /* 1107 */ { UD_Ipopfq, O_NONE, O_NONE, O_NONE, O_NONE, P_oso|P_def64 },
  /* 1108 */ { UD_Ipor, O_V, O_W, O_NONE, O_NONE, P_aso|P_rexr|P_rexx|P_rexb },
  /* 1109 */ { UD_Ivpor, O_Vx, O_Hx, O_Wx, O_NONE, P_aso|P_rexr|P_rexx|P_rexb },
  /* 1110 */ { UD_Ipor, O_P, O_Q, O_NONE, O_NONE, P_aso|P_rexr|P_rexx|P_rexb },
  /* 1111 */ { UD_Iprefetch, O_M, O_NONE, O_NONE, O_NONE, P_aso|P_rexw|P_rexr|P_rexx|P_rexb },
  /* 1112 */ { UD_Iprefetch, O_M, O_NONE, O_NONE, O_NONE, P_aso|P_rexw|P_rexr|P_rexx|P_rexb },
  /* 1113 */ { UD_Iprefetch, O_M, O_NONE, O_NONE, O_NONE, P_aso|P_rexw|P_rexr|P_rexx|P_rexb },
  /* 1114 */ { UD_Iprefetch, O_M, O_NONE, O_NONE, O_NONE, P_aso|P_rexw|P_rexr|P_rexx|P_rexb },
  ...
  /* 1119 */ { UD_Iprefetchnta, O_M, O_NONE, O_NONE, O_NONE, P_aso|P_rexw|P_rexr|P_rexx|P_rexb },
  /* 1120 */ { UD_Iprefetcht0, O_M, O_NONE, O_NONE, O_NONE, P_aso|P_rexw|P_rexr|P_rexx|P_rexb },
  /* 1121 */ { UD_Iprefetcht1, O_M, O_NONE, O_NONE, O_NONE, P_aso|P_rexw|P_rexr|P_rexx|P_rexb },
  /* 1122 */ { UD_Iprefetcht2, O_M, O_NONE, O_NONE, O_NONE, P_aso|P_rexw|P_rexr|P_rexx|P_rexb },
  /* 1123 */ { UD_Ipsadbw, O_V, O_W, O_NONE, O_NONE, P_aso|P_rexr|P_rexx|P_rexb },
  /* 1124 */ { UD_Ivpsadbw, O_Vx, O_Hx, O_Wx, O_NONE, P_aso|P_rexr|P_rexx|P_rexb },
  /* 1125 */ { UD_Ipsadbw, O_P, O_Q, O_NONE, O_NONE, P_aso|P_rexr|P_rexx|P_rexb },
  /* 1126 */ { UD_Ipshufw, O_P, O_Q, O_Ib, O_NONE, P_aso|P_rexr|P_rexx|P_rexb },
  /* 1127 */ { UD_Ipsllw, O_V, O_W, O_NONE, O_NONE, P_aso|P_rexr|P_rexx|P_rexb },
  /* 1128 */ { UD_Ipsllw, O_P, O_Q, O_NONE, O_NONE, P_aso|P_rexr|P_rexx|P_rexb },
  /* 1129 */ { UD_Ipsllw, O_U, O_Ib, O_NONE, O_NONE, P_rexb },
  /* 1130 */ { UD_Ipsllw, O_N, O_Ib, O_NONE, O_NONE, P_none },
  /* 1131 */ { UD_Ipslld, O_V, O_W, O_NONE, O_NONE, P_aso|P_rexr|P_rexx|P_rexb },
  /* 1132 */ { UD_Ipslld, O_P, O_Q, O_NONE, O_NONE, P_aso|P_rexr|P_rexx|P_rexb },
  /* 1133 */ { UD_Ipslld, O_U, O_Ib, O_NONE, O_NONE, P_rexb },
  /* 1134 */ { UD_Ipslld, O_N, O_Ib, O_NONE, O_NONE, P_none },
  /* 1135 */ { UD_Ipsllq, O_V, O_W, O_NONE, O_NONE, P_aso|P_rexr|P_rexx|P_rexb },
  /* 1136 */ { UD_Ipsllq, O_P, O_Q, O_NONE, O_NONE, P_aso|P_rexr|P_rexx|P_rexb },
  /* 1137 */ { UD_Ipsllq, O_U, O_Ib, O_NONE, O_NONE, P_rexb },
  /* 1138 */ { UD_Ipsllq, O_N, O_Ib, O_NONE, O_NONE, P_none },
  /* 1139 */ { UD_Ipsraw, O_P, O_Q, O_NONE, O_NONE, P_aso|P_rexr|P_rexx|P_rexb },
  /* 1140 */ { UD_Ipsraw, O_V, O_W, O_NONE, O_NONE, P_aso|P_rexr|P_rexx|P_rexb },
  /* 1141 */ { UD_Ivpsraw, O_Vx, O_Hx, O_Wx, O_NONE, P_aso|P_rexr|P_rexx|P_rexb },
  /* 1142 */ { UD_Ipsraw, O_U, O_Ib, O_NONE, O_NONE, P_rexb },
  /* 1143 */ { UD_Ivpsraw, O_Hx, O_Ux, O_Ib, O_NONE, P_rexb },
  /* 1144 */ { UD_Ipsraw, O_N, O_Ib, O_NONE, O_NONE, P_none },
  /* 1145 */ { UD_Ipsrad, O_N, O_Ib, O_NONE, O_NONE, P_none },
  /* 1146 */ { UD_Ipsrad, O_V, O_W, O_NONE, O_NONE, P_aso|P_rexr|P_rexx|P_rexb },
  /* 1147 */ { UD_Ivpsrad, O_Vx, O_Hx, O_Wx, O_NONE, P_aso|P_rexr|P_rexx|P_rexb },
  /* 1148 */ { UD_Ipsrad, O_P, O_Q, O_NONE, O_NONE, P_aso|P_rexr|P_rexx|P_rexb },
  /* 1149 */ { UD_Ipsrad, O_U, O_Ib, O_NONE, O_NONE, P_rexb },
  /* 1150 */ { UD_Ivpsrad, O_Hx, O_Ux, O_Ib, O_NONE, P_rexb },
  /* 1151 */ { UD_Ipsrlw, O_N, O_Ib, O_NONE, O_NONE, P_none },
  /* 1152 */ { UD_Ipsrlw, O_P, O_Q, O_NONE, O_NONE, P_aso|P_rexr|P_rexx|P_rexb },
  /* 1153 */ { UD_Ipsrlw, O_V, O_W, O_NONE, O_NONE, P_aso|P_rexr|P_rexx|P_rexb },
  /* 1154 */ { UD_Ivpsrlw, O_Vx, O_Hx, O_Wx, O_NONE, P_aso|P_rexr|P_rexx|P_rexb },
  /* 1155 */ { UD_Ipsrlw, O_U, O_Ib, O_NONE, O_NONE, P_rexb },
  /* 1156 */ { UD_Ivpsrlw, O_Hx, O_Ux, O_Ib, O_NONE, P_rexb },
  /* 1157 */ { UD_Ipsrld, O_N, O_Ib, O_NONE, O_NONE, P_none },
  /* 1158 */ { UD_Ipsrld, O_P, O_Q, O_NONE, O_NONE, P_aso|P_rexr|P_rexx|P_rexb },
  /* 1159 */ { UD_Ipsrld, O_V, O_W, O_NONE, O_NONE, P_aso|P_rexr|P_rexx|P_rexb },
  /* 1160 */ { UD_Ivpsrld, O_Vx, O_Hx, O_Wx, O_NONE, P_aso|P_rexr|P_rexx|P_rexb },
  /* 1161 */ { UD_Ipsrld, O_U, O_Ib, O_NONE, O_NONE, P_rexb },
  /* 1162 */ { UD_Ivpsrld, O_Hx, O_Ux, O_Ib, O_NONE, P_rexb },
  /* 1163 */ { UD_Ipsrlq, O_N, O_Ib, O_NONE, O_NONE, P_none },
  /* 1164 */ { UD_Ipsrlq, O_P, O_Q, O_NONE, O_NONE, P_aso|P_rexr|P_rexx|P_rexb },
  /* 1165 */ { UD_Ipsrlq, O_V, O_W, O_NONE, O_NONE, P_aso|P_rexr|P_rexx|P_rexb },
  /* 1166 */ { UD_Ivpsrlq, O_Vx, O_Hx, O_Wx, O_NONE, P_aso|P_rexr|P_rexx|P_rexb },
  /* 1167 */ { UD_Ipsrlq, O_U, O_Ib, O_NONE, O_NONE, P_rexb },
  /* 1168 */ { UD_Ivpsrlq, O_Hx, O_Ux, O_Ib, O_NONE, P_rexb },
  /* 1169 */ { UD_Ipsubb, O_V, O_W, O_NONE, O_NONE, P_aso|P_rexr|P_rexx|P_rexb },
  /* 1170 */ { UD_Ivpsubb, O_Vx, O_Hx, O_Wx, O_NONE, P_aso|P_rexr|P_rexx|P_rexb },
  /* 1171 */ { UD_Ipsubb, O_P, O_Q, O_NONE, O_NONE, P_aso|P_rexr|P_rexx|P_rexb },
  /* 1172 */ { UD_Ipsubw, O_V, O_W, O_NONE, O_NONE, P_aso|P_rexr|P_rexx|P_rexb },
  /* 1173 */ { UD_Ivpsubw, O_Vx, O_Hx, O_Wx, O_NONE, P_aso|P_rexr|P_rexx|P_rexb },
  /* 1174 */ { UD_Ipsubw, O_P, O_Q, O_NONE, O_NONE, P_aso|P_rexr|P_rexx|P_rexb },
  /* 1175 */ { UD_Ipsubd, O_P, O_Q, O_NONE, O_NONE, P_aso|P_rexr|P_rexx|P_rexb },
  /* 1176 */ { UD_Ipsubd, O_V, O_W, O_NONE, O_NONE, P_aso|P_rexr|P_rexx|P_rexb },
  /* 1177 */ { UD_Ivpsubd, O_Vx, O_Hx, O_Wx, O_NONE, P_aso|P_rexr|P_rexx|P_rexb },
  /* 1178 */ { UD_Ipsubsb, O_P, O_Q, O_NONE, O_NONE, P_aso|P_rexr|P_rexx|P_rexb },
  /* 1179 */ { UD_Ipsubsb, O_V, O_W, O_NONE, O_NONE, P_aso|P_rexr|P_rexx|P_rexb },
  /* 1180 */ { UD_Ivpsubsb, O_Vx, O_Hx, O_Wx, O_NONE, P_aso|P_rexr|P_rexx|P_rexb },
  /* 1181 */ { UD_Ipsubsw, O_P, O_Q, O_NONE, O_NONE, P_aso|P_rexr|P_rexx|P_rexb },
  /* 1182 */ { UD_Ipsubsw, O_V, O_W, O_NONE, O_NONE, P_aso|P_rexr|P_rexx|P_rexb },
  /* 1183 */ { UD_Ivpsubsw, O_Vx, O_Hx, O_Wx, O_NONE, P_aso|P_rexr|P_rexx|P_rexb },
  /* 1184 */ { UD_Ipsubusb, O_P, O_Q, O_NONE, O_NONE, P_aso|P_rexr|P_rexx|P_rexb },
  /* 1185 */ { UD_Ipsubusb, O_V, O_W, O_NONE, O_NONE, P_aso|P_rexr|P_rexx|P_rexb },
  /* 1186 */ { UD_Ivpsubusb, O_Vx, O_Hx, O_Wx, O_NONE, P_aso|P_rexr|P_rexx|P_rexb },
  /* 1187 */ { UD_Ipsubusw, O_P, O_Q, O_NONE, O_NONE, P_aso|P_rexr|P_rexx|P_rexb },
  /* 1188 */ { UD_Ipsubusw, O_V, O_W, O_NONE, O_NONE, P_aso|P_rexr|P_rexx|P_rexb },
  /* 1189 */ { UD_Ivpsubusw, O_Vx, O_Hx, O_Wx, O_NONE, P_aso|P_rexr|P_rexx|P_rexb },
  /* 1190 */ { UD_Ipunpckhbw, O_V, O_W, O_NONE, O_NONE, P_aso|P_rexr|P_rexx|P_rexb },
  /* 1191 */ { UD_Ivpunpckhbw, O_Vx, O_Hx, O_Wx, O_NONE, P_aso|P_rexr|P_rexx|P_rexb },
  /* 1192 */ { UD_Ipunpckhbw, O_P, O_Q, O_NONE, O_NONE, P_aso|P_rexr|P_rexx|P_rexb },
  /* 1193 */ { UD_Ipunpckhwd, O_V, O_W, O_NONE, O_NONE, P_aso|P_rexr|P_rexx|P_rexb },
  /* 1194 */ { UD_Ivpunpckhwd, O_Vx, O_Hx, O_Wx, O_NONE, P_aso|P_rexr|P_rexx|P_rexb },
  /* 1195 */ { UD_Ipunpckhwd, O_P, O_Q, O_NONE, O_NONE, P_aso|P_rexr|P_rexx|P_rexb },
  /* 1196 */ { UD_Ipunpckhdq, O_V, O_W, O_NONE, O_NONE, P_aso|P_rexr|P_rexx|P_rexb },
  /* 1197 */ { UD_Ivpunpckhdq, O_Vx, O_Hx, O_Wx, O_NONE, P_aso|P_rexr|P_rexx|P_rexb },
  /* 1198 */ { UD_Ipunpckhdq, O_P, O_Q, O_NONE, O_NONE, P_aso|P_rexr|P_rexx|P_rexb },
  /* 1199 */ { UD_Ipunpcklbw, O_V, O_W, O_NONE, O_NONE, P_aso|P_rexr|P_rexx|P_rexb },
  /* 1200 */ { UD_Ivpunpcklbw, O_Vx, O_Hx, O_Wx, O_NONE, P_aso|P_rexr|P_rexx|P_rexb },
  /* 1201 */ { UD_Ipunpcklbw, O_P, O_Q, O_NONE, O_NONE, P_aso|P_rexr|P_rexx|P_rexb },
  /* 1202 */ { UD_Ipunpcklwd, O_V, O_W, O_NONE, O_NONE, P_aso|P_rexr|P_rexx|P_rexb },
  /* 1203 */ { UD_Ivpunpcklwd, O_Vx, O_Hx, O_Wx, O_NONE, P_aso|P_rexr|P_rexx|P_rexb },
  /* 1204 */ { UD_Ipunpcklwd, O_P, O_Q, O_NONE, O_NONE, P_aso|P_rexr|P_rexx|P_rexb },
  /* 1205 */ { UD_Ipunpckldq, O_V, O_W, O_NONE, O_NONE, P_aso|P_rexr|P_rexx|P_rexb },
  /* 1206 */ { UD_Ivpunpckldq, O_Vx, O_Hx, O_Wx, O_NONE, P_aso|P_rexr|P_rexx|P_rexb },
  /* 1207 */ { UD_Ipunpckldq, O_P, O_Q, O_NONE, O_NONE, P_aso|P_rexr|P_rexx|P_rexb },
  /* 1208 */ { UD_Ipi2fw, O_P, O_Q, O_NONE, O_NONE, P_aso|P_rexr|P_rexx|P_rexb },
  /* 1209 */ { UD_Ipi2fd, O_P, O_Q, O_NONE, O_NONE, P_aso|P_rexr|P_rexx|P_rexb },
  /* 1210 */ { UD_Ipf2iw, O_P, O_Q, O_NONE, O_NONE, P_aso|P_rexr|P_rexx|P_rexb },
  /* 1211 */ { UD_Ipf2id, O_P, O_Q, O_NONE, O_NONE, P_aso|P_rexr|P_rexx|P_rexb },
  /* 1212 */ { UD_Ipfnacc, O_P, O_Q, O_NONE, O_NONE, P_aso|P_rexr|P_rexx|P_rexb },
  /* 1213 */ { UD_Ipfpnacc, O_P, O_Q, O_NONE, O_NONE, P_aso|P_rexr|P_rexx|P_rexb },
  /* 1214 */ { UD_Ipfcmpge, O_P, O_Q, O_NONE, O_NONE, P_aso|P_rexr|P_rexx|P_rexb },
  /* 1215 */ { UD_Ipfmin, O_P, O_Q, O_NONE, O_NONE, P_aso|P_rexr|P_rexx|P_rexb },
  /* 1216 */ { UD_Ipfrcp, O_P, O_Q, O_NONE, O_NONE, P_aso|P_rexr|P_rexx|P_rexb },
  /* 1217 */ { UD_Ipfrsqrt, O_P, O_Q, O_NONE, O_NONE, P_aso|P_rexr|P_rexx|P_rexb },
  /* 1218 */ { UD_Ipfsub, O_P, O_Q, O_NONE, O_NONE, P_aso|P_rexr|P_rexx|P_rexb },
  /* 1219 */ { UD_Ipfadd, O_P, O_Q, O_NONE, O_NONE, P_aso|P_rexr|P_rexx|P_rexb },
  /* 1220 */ { UD_Ipfcmpgt, O_P, O_Q, O_NONE, O_NONE, P_aso|P_rexr|P_rexx|P_rexb },
  /* 1221 */ { UD_Ipfmax, O_P, O_Q, O_NONE, O_NONE, P_aso|P_rexr|P_rexx|P_rexb },
  /* 1222 */ { UD_Ipfrcpit1, O_P, O_Q, O_NONE, O_NONE, P_aso|P_rexr|P_rexx|P_rexb },
  /* 1223 */ { UD_Ipfrsqit1, O_P, O_Q, O_NONE, O_NONE, P_aso|P_rexr|P_rexx|P_rexb },
  /* 1224 */ { UD_Ipfsubr, O_P, O_Q, O_NONE, O_NONE, P_aso|P_rexr|P_rexx|P_rexb },
  /* 1225 */ { UD_Ipfacc, O_P, O_Q, O_NONE, O_NONE, P_aso|P_rexr|P_rexx|P_rexb },
  /* 1226 */ { UD_Ipfcmpeq, O_P, O_Q, O_NONE, O_NONE, P_aso|P_rexr|P_rexx|P_rexb },
  /* 1227 */ { UD_Ipfmul, O_P, O_Q, O_NONE, O_NONE, P_aso|P_rexr|P_rexx|P_rexb },
  /* 1228 */ { UD_Ipfrcpit2, O_P, O_Q, O_NONE, O_NONE, P_aso|P_rexr|P_rexx|P_rexb },
  /* 1229 */ { UD_Ipmulhrw, O_P, O_Q, O_NONE, O_NONE, P_aso|P_rexr|P_rexx|P_rexb },
  /* 1230 */ { UD_Ipswapd, O_P, O_Q, O_NONE, O_NONE, P_aso|P_rexr|P_rexx|P_rexb },
  /* 1231 */ { UD_Ipavgusb, O_P, O_Q, O_NONE, O_NONE, P_aso|P_rexr|P_rexx|P_rexb },
  /* 1232 */ { UD_Ipush, O_ES, O_NONE, O_NONE, O_NONE, P_inv64 },
  /* 1233 */ { UD_Ipush, O_CS, O_NONE, O_NONE, O_NONE, P_inv64 },
  /* 1234 */ { UD_Ipush, O_SS, O_NONE, O_NONE, O_NONE, P_inv64 },
  /* 1235 */ { UD_Ipush, O_DS, O_NONE, O_NONE, O_NONE, P_inv64 },
  /* 1236 */ { UD_Ipush, O_GS, O_NONE, O_NONE, O_NONE, P_none },
  /* 1237 */ { UD_Ipush, O_FS, O_NONE, O_NONE, O_NONE, P_none },
  /* 1238 */ { UD_Ipush, O_R0v, O_NONE, O_NONE, O_NONE, P_oso|P_rexb|P_def64 },
  /* 1239 */ { UD_Ipush, O_R1v, O_NONE, O_NONE, O_NONE, P_oso|P_rexb|P_def64 },
  /* 1240 */ { UD_Ipush, O_R2v, O_NONE, O_NONE, O_NONE, P_oso|P_rexb|P_def64 },
  /* 1241 */ { UD_Ipush, O_R3v, O_NONE, O_NONE, O_NONE, P_oso|P_rexb|P_def64 },
  /* 1242 */ { UD_Ipush, O_R4v, O_NONE, O_NONE, O_NONE, P_oso|P_rexb|P_def64 },
  /* 1243 */ { UD_Ipush, O_R5v, O_NONE, O_NONE, O_NONE, P_oso|P_rexb|P_def64 },
  /* 1244 */ { UD_Ipush, O_R6v, O_NONE, O_NONE, O_NONE, P_oso|P_rexb|P_def64 },
  /* 1245 */ { UD_Ipush, O_R7v, O_NONE, O_NONE, O_NONE, P_oso|P_rexb|P_def64 },
  /* 1246 */ { UD_Ipush, O_sIz, O_NONE, O_NONE, O_NONE, P_oso|P_def64 },
  /* 1247 */ { UD_Ipush, O_Ev, O_NONE, O_NONE, O_NONE, P_aso|P_oso|P_rexw|P_rexr|P_rexx|P_rexb|P_def64 },
  /* 1248 */ { UD_Ipush, O_sIb, O_NONE, O_NONE, O_NONE, P_oso|P_def64 },
  /* 1249 */ { UD_Ipusha, O_NONE, O_NONE, O_NONE, O_NONE, P_oso|P_inv64 },
  /* 1250 */ { UD_Ipushad, O_NONE, O_NONE, O_NONE, O_NONE, P_oso|P_inv64 },
  /* 1251 */ { UD_Ipushfw, O_NONE, O_NONE, O_NONE, O_NONE, P_oso },
  /* 1252 */ { UD_Ipushfw, O_NONE, O_NONE, O_NONE, O_NONE, P_oso|P_rexw|P_def64 },
  /* 1253 */ { UD_Ipushfd, O_NONE, O_NONE, O_NONE, O_NONE, P_oso },
  /* 1254 */ { UD_Ipushfq, O_NONE, O_NONE, O_NONE, O_NONE, P_oso|P_rexw|P_def64 },
  /* 1255 */ { UD_Ipushfq, O_NONE, O_NONE, O_NONE, O_NONE, P_oso|P_rexw|P_def64 },
  /* 1256 */ { UD_Ipxor, O_V, O_W, O_NONE, O_NONE, P_aso|P_rexr|P_rexx|P_rexb },
  /* 1257 */ { UD_Ivpxor, O_Vx, O_Hx, O_Wx, O_NONE, P_aso|P_rexr|P_rexx|P_rexb },
  /* 1258 */ { UD_Ipxor, O_P, O_Q, O_NONE, O_NONE, P_aso|P_rexr|P_rexx|P_rexb },
  /* 1259 */ { UD_Ircl, O_Eb, O_Ib, O_NONE, O_NONE, P_aso|P_rexw|P_rexr|P_rexx|P_rexb },
  /* 1260 */ { UD_Ircl, O_Ev, O_Ib, O_NONE, O_NONE, P_aso|P_oso|P_rexw|P_rexr|P_rexx|P_rexb },
  /* 1261 */ { UD_Ircl, O_Eb, O_I1, O_NONE, O_NONE, P_aso|P_rexw|P_rexr|P_rexx|P_rexb },
  /* 1262 */ { UD_Ircl, O_Eb, O_CL, O_NONE, O_NONE, P_aso|P_rexw|P_rexr|P_rexx|P_rexb },
  /* 1263 */ { UD_Ircl, O_Ev, O_CL, O_NONE, O_NONE, P_aso|P_oso|P_rexw|P_rexr|P_rexx|P_rexb },
  /* 1264 */ { UD_Ircl, O_Ev, O_I1, O_NONE, O_NONE, P_aso|P_oso|P_rexw|P_rexr|P_rexx|P_rexb },
  /* 1265 */ { UD_Ircr, O_Eb, O_I1, O_NONE, O_NONE, P_aso|P_rexw|P_rexr|P_rexx|P_rexb },
  /* 1266 */ { UD_Ircr, O_Ev, O_Ib, O_NONE, O_NONE, P_aso|P_oso|P_rexw|P_rexr|P_rexx|P_rexb },
  /* 1267 */ { UD_Ircr, O_Eb, O_Ib, O_NONE, O_NONE, P_aso|P_rexw|P_rexr|P_rexx|P_rexb },
  /* 1268 */ { UD_Ircr, O_Ev, O_I1, O_NONE, O_NONE, P_aso|P_oso|P_rexw|P_rexr|P_rexx|P_rexb },
  /* 1269 */ { UD_Ircr, O_Eb, O_CL, O_NONE, O_NONE, P_aso|P_rexw|P_rexr|P_rexx|P_rexb },
  /* 1270 */ { UD_Ircr, O_Ev, O_CL, O_NONE, O_NONE, P_aso|P_oso|P_rexw|P_rexr|P_rexx|P_rexb },
  /* 1271 */ { UD_Irol, O_Eb, O_Ib, O_NONE, O_NONE, P_aso|P_rexw|P_rexr|P_rexx|P_rexb },
  /* 1272 */ { UD_Irol, O_Eb, O_I1, O_NONE, O_NONE, P_aso|P_rexw|P_rexr|P_rexx|P_rexb },
  /* 1273 */ { UD_Irol, O_Ev, O_I1, O_NONE, O_NONE, P_aso|P_oso|P_rexw|P_rexr|P_rexx|P_rexb },
  /* 1274 */ { UD_Irol, O_Eb, O_CL, O_NONE, O_NONE, P_aso|P_rexw|P_rexr|P_rexx|P_rexb },
  /* 1275 */ { UD_Irol, O_Ev, O_CL, O_NONE, O_NONE, P_aso|P_oso|P_rexw|P_rexr|P_rexx|P_rexb },
  /* 1276 */ { UD_Irol, O_Ev, O_Ib, O_NONE, O_NONE, P_aso|P_oso|P_rexw|P_rexr|P_rexx|P_rexb },
  /* 1277 */ { UD_Iror, O_Eb, O_I1, O_NONE, O_NONE, P_aso|P_rexw|P_rexr|P_rexx|P_rexb },
  /* 1278 */ { UD_Iror, O_Eb, O_Ib, O_NONE, O_NONE, P_aso|P_rexw|P_rexr|P_rexx|P_rexb },
  /* 1279 */ { UD_Iror, O_Ev, O_Ib, O_NONE, O_NONE, P_aso|P_oso|P_rexw|P_rexr|P_rexx|P_rexb },
  /* 1280 */ { UD_Iror, O_Ev, O_I1, O_NONE, O_NONE, P_aso|P_oso|P_rexw|P_rexr|P_rexx|P_rexb },
  /* 1281 */ { UD_Iror, O_Eb, O_CL, O_NONE, O_NONE, P_aso|P_rexw|P_rexr|P_rexx|P_rexb },
  /* 1282 */ { UD_Iror, O_Ev, O_CL, O_NONE, O_NONE, P_aso|P_oso|P_rexw|P_rexr|P_rexx|P_rexb },
  /* 1283 */ { UD_Ircpps, O_V, O_W, O_NONE, O_NONE, P_aso|P_rexr|P_rexx|P_rexb },
  /* 1284 */ { UD_Ivrcpps, O_Vx, O_Wx, O_NONE, O_NONE, P_aso|P_rexr|P_rexx|P_rexb|P_vexl },
  /* 1285 */ { UD_Ircpss, O_V, O_W, O_NONE, O_NONE, P_aso|P_rexr|P_rexx|P_rexb },
  /* 1286 */ { UD_Ivrcpss, O_Vx, O_Wx, O_NONE, O_NONE, P_aso|P_rexr|P_rexx|P_rexb },
  /* 1287 */ { UD_Irdmsr, O_NONE, O_NONE, O_NONE, O_NONE, P_none },
  /* 1288 */ { UD_Irdpmc, O_NONE, O_NONE, O_NONE, O_NONE, P_none },
  /* 1289 */ { UD_Irdtsc, O_NONE, O_NONE, O_NONE, O_NONE, P_none },
  /* 1290 */ { UD_Irdtscp, O_NONE, O_NONE, O_NONE, O_NONE, P_none },
  /* 1291 */ { UD_Irepne, O_NONE, O_NONE, O_NONE, O_NONE, P_none },
  /* 1292 */ { UD_Irep, O_NONE, O_NONE, O_NONE, O_NONE, P_none },
  /* 1293 */ { UD_Iret, O_Iw, O_NONE, O_NONE, O_NONE, P_none },
  /* 1294 */ { UD_Iret, O_NONE, O_NONE, O_NONE, O_NONE, P_none },
  /* 1295 */ { UD_Iretf, O_Iw, O_NONE, O_NONE, O_NONE, P_none },
  /* 1296 */ { UD_Iretf, O_NONE, O_NONE, O_NONE, O_NONE, P_none },
  /* 1297 */ { UD_Irsm, O_NONE, O_NONE, O_NONE, O_NONE, P_none },
  /* 1298 */ { UD_Irsqrtps, O_V, O_W, O_NONE, O_NONE, P_aso|P_rexr|P_rexx|P_rexb },
  /* 1299 */ { UD_Ivrsqrtps, O_Vx, O_Wx, O_NONE, O_NONE, P_aso|P_rexr|P_rexx|P_rexb|P_vexl },
  /* 1300 */ { UD_Irsqrtss, O_V, O_W, O_NONE, O_NONE, P_aso|P_rexr|P_rexx|P_rexb },
  /* 1301 */ { UD_Ivrsqrtss, O_Vx, O_Wx, O_NONE, O_NONE, P_aso|P_rexr|P_rexx|P_rexb },
  /* 1302 */ { UD_Isahf, O_NONE, O_NONE, O_NONE, O_NONE, P_none },
  /* 1303 */ { UD_Isalc, O_NONE, O_NONE, O_NONE, O_NONE, P_inv64 },
  /* 1304 */ { UD_Isar, O_Ev, O_I1, O_NONE, O_NONE, P_aso|P_oso|P_rexw|P_rexr|P_rexx|P_rexb },
  /* 1305 */ { UD_Isar, O_Eb, O_Ib, O_NONE, O_NONE, P_aso|P_rexw|P_rexr|P_rexx|P_rexb },
  /* 1306 */ { UD_Isar, O_Eb, O_I1, O_NONE, O_NONE, P_aso|P_rexw|P_rexr|P_rexx|P_rexb },
  /* 1307 */ { UD_Isar, O_Ev, O_Ib, O_NONE, O_NONE, P_aso|P_oso|P_rexw|P_rexr|P_rexx|P_rexb },
  /* 1308 */ { UD_Isar, O_Eb, O_CL, O_NONE, O_NONE, P_aso|P_rexw|P_rexr|P_rexx|P_rexb },
  /* 1309 */ { UD_Isar, O_Ev, O_CL, O_NONE, O_NONE, P_aso|P_oso|P_rexw|P_rexr|P_rexx|P_rexb },
  /* 1310 */ { UD_Ishl, O_Eb, O_Ib, O_NONE, O_NONE, P_aso|P_rexw|P_rexr|P_rexx|P_rexb },
  /* 1311 */ { UD_Ishl, O_Ev, O_Ib, O_NONE, O_NONE, P_aso|P_oso|P_rexw|P_rexr|P_rexx|P_rexb },
  /* 1312 */ { UD_Ishl, O_Eb, O_I1, O_NONE, O_NONE, P_aso|P_rexw|P_rexr|P_rexx|P_rexb },
  /* 1313 */ { UD_Ishl, O_Eb, O_CL, O_NONE, O_NONE, P_aso|P_rexw|P_rexr|P_rexx|P_rexb },
  /* 1314 */ { UD_Ishl, O_Ev, O_CL, O_NONE, O_NONE, P_aso|P_oso|P_rexw|P_rexr|P_rexx|P_rexb },
  /* 1315 */ { UD_Ishl, O_Ev, O_Ib, O_NONE, O_NONE, P_aso|P_oso|P_rexw|P_rexr|P_rexx|P_rexb },
  /* 1316 */ { UD_Ishl, O_Eb, O_CL, O_NONE, O_NONE, P_aso|P_rexr|P_rexx|P_rexb },
  /* 1317 */ { UD_Ishl, O_Ev, O_I1, O_NONE, O_NONE, P_aso|P_oso|P_rexw|P_rexr|P_rexx|P_rexb },
  /* 1318 */ { UD_Ishl, O_Eb, O_I1, O_NONE, O_NONE, P_aso|P_rexw|P_rexr|P_rexx|P_rexb },
  /* 1319 */ { UD_Ishl, O_Eb, O_Ib, O_NONE, O_NONE, P_aso|P_rexw|P_rexr|P_rexx|P_rexb },
  /* 1320 */ { UD_Ishl, O_Ev, O_CL, O_NONE, O_NONE, P_aso|P_oso|P_rexw|P_rexr|P_rexx|P_rexb },
  /* 1321 */ { UD_Ishl, O_Ev, O_I1, O_NONE, O_NONE, P_aso|P_oso|P_rexw|P_rexr|P_rexx|P_rexb },
  /* 1322 */ { UD_Ishr, O_Ev, O_Ib, O_NONE, O_NONE, P_aso|P_oso|P_rexw|P_rexr|P_rexx|P_rexb },
  /* 1323 */ { UD_Ishr, O_Eb, O_CL, O_NONE, O_NONE, P_aso|P_rexw|P_rexr|P_rexx|P_rexb },
  /* 1324 */ { UD_Ishr, O_Ev, O_I1, O_NONE, O_NONE, P_aso|P_oso|P_rexw|P_rexr|P_rexx|P_rexb },
  /* 1325 */ { UD_Ishr, O_Eb, O_I1, O_NONE, O_NONE, P_aso|P_rexw|P_rexr|P_rexx|P_rexb },
  /* 1326 */ { UD_Ishr, O_Eb, O_Ib, O_NONE, O_NONE, P_aso|P_rexw|P_rexr|P_rexx|P_rexb },
  /* 1327 */ { UD_Ishr, O_Ev, O_CL, O_NONE, O_NONE, P_aso|P_oso|P_rexw|P_rexr|P_rexx|P_rexb },
  /* 1328 */ { UD_Isbb, O_Eb, O_Gb, O_NONE, O_NONE, P_aso|P_rexr|P_rexx|P_rexb },
  /* 1329 */ { UD_Isbb, O_Ev, O_Gv, O_NONE, O_NONE, P_aso|P_oso|P_rexw|P_rexr|P_rexx|P_rexb },
  /* 1330 */ { UD_Isbb, O_Gb, O_Eb, O_NONE, O_NONE, P_aso|P_rexr|P_rexx|P_rexb },
  /* 1331 */ { UD_Isbb, O_Gv, O_Ev, O_NONE, O_NONE, P_aso|P_oso|P_rexw|P_rexr|P_rexx|P_rexb },
  /* 1332 */ { UD_Isbb, O_AL, O_Ib, O_NONE, O_NONE, P_none },
  /* 1333 */ { UD_Isbb, O_rAX, O_sIz, O_NONE, O_NONE, P_oso|P_rexw },
  /* 1334 */ { UD_Isbb, O_Eb, O_Ib, O_NONE, O_NONE, P_aso|P_rexr|P_rexx|P_rexb },
  /* 1335 */ { UD_Isbb, O_Ev, O_sIz, O_NONE, O_NONE, P_aso|P_oso|P_rexw|P_rexr|P_rexx|P_rexb },
  /* 1336 */ { UD_Isbb, O_Eb, O_Ib, O_NONE, O_NONE, P_aso|P_rexr|P_rexx|P_rexb|P_inv64 },
  /* 1337 */ { UD_Isbb, O_Ev, O_sIb, O_NONE, O_NONE, P_aso|P_oso|P_rexw|P_rexr|P_rexx|P_rexb },
  /* 1338 */ { UD_Iscasb, O_NONE, O_NONE, O_NONE, O_NONE, P_strz },
  /* 1339 */ { UD_Iscasw, O_NONE, O_NONE, O_NONE, O_NONE, P_strz|P_oso|P_rexw },
  /* 1340 */ { UD_Iscasd, O_NONE, O_NONE, O_NONE, O_NONE, P_strz|P_oso|P_rexw },
  /* 1341 */ { UD_Iscasq, O_NONE, O_NONE, O_NONE, O_NONE, P_strz|P_oso|P_rexw },
  /* 1342 */ { UD_Iseto, O_Eb, O_NONE, O_NONE, O_NONE, P_aso|P_rexr|P_rexx|P_rexb },
  /* 1343 */ { UD_Isetno, O_Eb, O_NONE, O_NONE, O_NONE, P_aso|P_rexr|P_rexx|P_rexb },
  /* 1344 */ { UD_Isetb, O_Eb, O_NONE, O_NONE, O_NONE, P_aso|P_rexr|P_rexx|P_rexb },
  /* 1345 */ { UD_Isetae, O_Eb, O_NONE, O_NONE, O_NONE, P_aso|P_rexr|P_rexx|P_rexb },
  /* 1346 */ { UD_Isetz, O_Eb, O_NONE, O_NONE, O_NONE, P_aso|P_rexr|P_rexx|P_rexb },
  /* 1347 */ { UD_Isetnz, O_Eb, O_NONE, O_NONE, O_NONE, P_aso|P_rexr|P_rexx|P_rexb },
  /* 1348 */ { UD_Isetbe, O_Eb, O_NONE, O_NONE, O_NONE, P_aso|P_rexr|P_rexx|P_rexb },
  /* 1349 */ { UD_Iseta, O_Eb, O_NONE, O_NONE, O_NONE, P_aso|P_rexr|P_rexx|P_rexb },
  /* 1350 */ { UD_Isets, O_Eb, O_NONE, O_NONE, O_NONE, P_aso|P_rexr|P_rexx|P_rexb },
  /* 1351 */ { UD_Isetns, O_Eb, O_NONE, O_NONE, O_NONE, P_aso|P_rexr|P_rexx|P_rexb },
  /* 1352 */ { UD_Isetp, O_Eb, O_NONE, O_NONE, O_NONE, P_aso|P_rexr|P_rexx|P_rexb },
  /* 1353 */ { UD_Isetnp, O_Eb, O_NONE, O_NONE, O_NONE, P_aso|P_rexr|P_rexx|P_rexb },
  /* 1354 */ { UD_Isetl, O_Eb, O_NONE, O_NONE, O_NONE, P_aso|P_rexr|P_rexx|P_rexb },
  /* 1355 */ { UD_Isetge, O_Eb, O_NONE, O_NONE, O_NONE, P_aso|P_rexr|P_rexx|P_rexb },
  /* 1356 */ { UD_Isetle, O_Eb, O_NONE, O_NONE, O_NONE, P_aso|P_rexr|P_rexx|P_rexb },
  /* 1357 */ { UD_Isetg, O_Eb, O_NONE, O_NONE, O_NONE, P_aso|P_rexr|P_rexx|P_rexb },
  /* 1358 */ { UD_Isfence, O_NONE, O_NONE, O_NONE, O_NONE, P_none },
  /* 1359 */ { UD_Isfence, O_NONE, O_NONE, O_NONE, O_NONE, P_none },
  /* 1360 */ { UD_Isfence, O_NONE, O_NONE, O_NONE, O_NONE, P_none },
  /* 1361 */ { UD_Isfence, O_NONE, O_NONE, O_NONE, O_NONE, P_none },
  ...
  /* 1366 */ { UD_Isgdt, O_M, O_NONE, O_NONE, O_NONE, P_aso|P_rexr|P_rexx|P_rexb },
  /* 1367 */ { UD_Ishld, O_Ev, O_Gv, O_Ib, O_NONE, P_aso|P_oso|P_rexw|P_rexr|P_rexx|P_rexb },
  /* 1368 */ { UD_Ishld, O_Ev, O_Gv, O_CL, O_NONE, P_aso|P_oso|P_rexw|P_rexr|P_rexx|P_rexb },
  /* 1369 */ { UD_Ishrd, O_Ev, O_Gv, O_Ib, O_NONE, P_aso|P_oso|P_rexw|P_rexr|P_rexx|P_rexb },
  /* 1370 */ { UD_Ishrd, O_Ev, O_Gv, O_CL, O_NONE, P_aso|P_oso|P_rexw|P_rexr|P_rexx|P_rexb },
  /* 1371 */ { UD_Ishufpd, O_V, O_W, O_Ib, O_NONE, P_aso|P_rexr|P_rexx|P_rexb },
  /* 1372 */ { UD_Ivshufpd, O_Vx, O_Hx, O_Wx, O_Ib, P_aso|P_rexr|P_rexx|P_rexb|P_vexl },
  /* 1373 */ { UD_Ishufps, O_V, O_W, O_Ib, O_NONE, P_aso|P_rexr|P_rexx|P_rexb },
  /* 1374 */ { UD_Ivshufps, O_Vx, O_Hx, O_Wx, O_Ib, P_aso|P_rexr|P_rexx|P_rexb },
  /* 1375 */ { UD_Isidt, O_M, O_NONE, O_NONE, O_NONE, P_aso|P_rexr|P_rexx|P_rexb },
  /* 1376 */ { UD_Isldt, O_MwRv, O_NONE, O_NONE, O_NONE, P_aso|P_oso|P_rexr|P_rexw|P_rexx|P_rexb },
  /* 1377 */ { UD_Ismsw, O_MwRv, O_NONE, O_NONE, O_NONE, P_aso|P_oso|P_rexr|P_rexw|P_rexx|P_rexb },
  /* 1378 */ { UD_Ismsw, O_MwRv, O_NONE, O_NONE, O_NONE, P_aso|P_oso|P_rexr|P_rexw|P_rexx|P_rexb },
  /* 1379 */ { UD_Isqrtps, O_V, O_W, O_NONE, O_NONE, P_aso|P_rexr|P_rexx|P_rexb },
  /* 1380 */ { UD_Ivsqrtps, O_Vx, O_Wx, O_NONE, O_NONE, P_aso|P_rexr|P_rexx|P_rexb|P_vexl },
  /* 1381 */ { UD_Isqrtpd, O_V, O_W, O_NONE, O_NONE, P_aso|P_rexr|P_rexx|P_rexb },
  /* 1382 */ { UD_Ivsqrtpd, O_Vx, O_Wx, O_NONE, O_NONE, P_aso|P_rexr|P_rexx|P_rexb },
  /* 1383 */ { UD_Isqrtsd, O_V, O_W, O_NONE, O_NONE, P_aso|P_rexr|P_rexx|P_rexb },
  /* 1384 */ { UD_Ivsqrtsd, O_Vx, O_Hx, O_Wx, O_NONE, P_aso|P_rexr|P_rexx|P_rexb },
  /* 1385 */ { UD_Isqrtss, O_V, O_W, O_NONE, O_NONE, P_aso|P_rexr|P_rexx|P_rexb },
  /* 1386 */ { UD_Ivsqrtss, O_Vx, O_Hx, O_Wx, O_NONE, P_aso|P_rexr|P_rexx|P_rexb },
  /* 1387 */ { UD_Istc, O_NONE, O_NONE, O_NONE, O_NONE, P_none },
  /* 1388 */ { UD_Istd, O_NONE, O_NONE, O_NONE, O_NONE, P_none },
  /* 1389 */ { UD_Istgi, O_NONE, O_NONE, O_NONE, O_NONE, P_none },
  /* 1390 */ { UD_Isti, O_NONE, O_NONE, O_NONE, O_NONE, P_none },
  /* 1391 */ { UD_Iskinit, O_NONE, O_NONE, O_NONE, O_NONE, P_none },
  /* 1392 */ { UD_Istmxcsr, O_Md, O_NONE, O_NONE, O_NONE, P_aso|P_rexw|P_rexr|P_rexx|P_rexb },
  /* 1393 */ { UD_Ivstmxcsr, O_Md, O_NONE, O_NONE, O_NONE, P_aso|P_rexw|P_rexr|P_rexx|P_rexb },
  /* 1394 */ { UD_Istosb, O_NONE, O_NONE, O_NONE, O_NONE, P_str|P_seg },
  /* 1395 */ { UD_Istosw, O_NONE, O_NONE, O_NONE, O_NONE, P_str|P_seg|P_oso|P_rexw },
  /* 1396 */ { UD_Istosd, O_NONE, O_NONE, O_NONE, O_NONE, P_str|P_seg|P_oso|P_rexw },
  /* 1397 */ { UD_Istosq, O_NONE, O_NONE, O_NONE, O_NONE, P_str|P_seg|P_oso|P_rexw },
  /* 1398 */ { UD_Istr, O_MwRv, O_NONE, O_NONE, O_NONE, P_aso|P_oso|P_rexr|P_rexw|P_rexx|P_rexb },
  /* 1399 */ { UD_Isub, O_Eb, O_Gb, O_NONE, O_NONE, P_aso|P_rexr|P_rexx|P_rexb },
  /* 1400 */ { UD_Isub, O_Ev, O_Gv, O_NONE, O_NONE, P_aso|P_oso|P_rexw|P_rexr|P_rexx|P_rexb },
  /* 1401 */ { UD_Isub, O_Gb, O_Eb, O_NONE, O_NONE, P_aso|P_rexr|P_rexx|P_rexb },
  /* 1402 */ { UD_Isub, O_Gv, O_Ev, O_NONE, O_NONE, P_aso|P_oso|P_rexw|P_rexr|P_rexx|P_rexb },
  /* 1403 */ { UD_Isub, O_AL, O_Ib, O_NONE, O_NONE, P_none },
  /* 1404 */ { UD_Isub, O_rAX, O_sIz, O_NONE, O_NONE, P_oso|P_rexw },
  /* 1405 */ { UD_Isub, O_Eb, O_Ib, O_NONE, O_NONE, P_aso|P_rexr|P_rexx|P_rexb },
  /* 1406 */ { UD_Isub, O_Ev, O_sIz, O_NONE, O_NONE, P_aso|P_oso|P_rexw|P_rexr|P_rexx|P_rexb },
  /* 1407 */ { UD_Isub, O_Eb, O_Ib, O_NONE, O_NONE, P_aso|P_rexr|P_rexx|P_rexb|P_inv64 },
  /* 1408 */ { UD_Isub, O_Ev, O_sIb, O_NONE, O_NONE, P_aso|P_oso|P_rexw|P_rexr|P_rexx|P_rexb },
  /* 1409 */ { UD_Isubpd, O_V, O_W, O_NONE, O_NONE, P_aso|P_rexr|P_rexx|P_rexb },
  /* 1410 */ { UD_Ivsubpd, O_Vx, O_Hx, O_Wx, O_NONE, P_aso|P_rexr|P_rexx|P_rexb|P_vexl },
  /* 1411 */ { UD_Isubps, O_V, O_W, O_NONE, O_NONE, P_aso|P_rexr|P_rexx|P_rexb },
  /* 1412 */ { UD_Ivsubps, O_Vx, O_Hx, O_Wx, O_NONE, P_aso|P_rexr|P_rexx|P_rexb|P_vexl },
  /* 1413 */ { UD_Isubsd, O_V, O_W, O_NONE, O_NONE, P_aso|P_rexr|P_rexx|P_rexb },
  /* 1414 */ { UD_Ivsubsd, O_Vx, O_Hx, O_Wx, O_NONE, P_aso|P_rexr|P_rexx|P_rexb },
  /* 1415 */ { UD_Isubss, O_V, O_W, O_NONE, O_NONE, P_aso|P_rexr|P_rexx|P_rexb },
  /* 1416 */ { UD_Ivsubss, O_Vx, O_Hx, O_Wx, O_NONE, P_aso|P_rexr|P_rexx|P_rexb },
  /* 1417 */ { UD_Iswapgs, O_NONE, O_NONE, O_NONE, O_NONE, P_none },
  /* 1418 */ { UD_Isyscall, O_NONE, O_NONE, O_NONE, O_NONE, P_none },
  /* 1419 */ { UD_Isysenter, O_NONE, O_NONE, O_NONE, O_NONE, P_none },
  /* 1420 */ { UD_Isysenter, O_NONE, O_NONE, O_NONE, O_NONE, P_none },
  /* 1421 */ { UD_Isysexit, O_NONE, O_NONE, O_NONE, O_NONE, P_none },
  /* 1422 */ { UD_Isysexit, O_NONE, O_NONE, O_NONE, O_NONE, P_none },
  /* 1423 */ { UD_Isysret, O_NONE, O_NONE, O_NONE, O_NONE, P_none },
  /* 1424 */ { UD_Itest, O_Eb, O_Ib, O_NONE, O_NONE, P_aso|P_rexw|P_rexr|P_rexx|P_rexb },
  /* 1425 */ { UD_Itest, O_Eb, O_Gb, O_NONE, O_NONE, P_aso|P_rexr|P_rexx|P_rexb },
  /* 1426 */ { UD_Itest, O_Ev, O_Gv, O_NONE, O_NONE, P_aso|P_oso|P_rexw|P_rexr|P_rexx|P_rexb },
  /* 1427 */ { UD_Itest, O_AL, O_Ib, O_NONE, O_NONE, P_none },
  /* 1428 */ { UD_Itest, O_rAX, O_sIz, O_NONE, O_NONE, P_oso|P_rexw },
  /* 1429 */ { UD_Itest, O_Eb, O_Ib, O_NONE, O_NONE, P_aso|P_rexw|P_rexr|P_rexx|P_rexb },
  /* 1430 */ { UD_Itest, O_Ev, O_sIz, O_NONE, O_NONE, P_aso|P_oso|P_rexw|P_rexr|P_rexx|P_rexb },
  /* 1431 */ { UD_Itest, O_Ev, O_Iz, O_NONE, O_NONE, P_aso|P_oso|P_rexw|P_rexr|P_rexx|P_rexb },
  /* 1432 */ { UD_Iucomisd, O_V, O_W, O_NONE, O_NONE, P_aso|P_rexr|P_rexx|P_rexb },
  /* 1433 */ { UD_Ivucomisd, O_Vx, O_Wx, O_NONE, O_NONE, P_aso|P_rexr|P_rexx|P_rexb },
  /* 1434 */ { UD_Iucomiss, O_V, O_W, O_NONE, O_NONE, P_aso|P_rexr|P_rexx|P_rexb },
  /* 1435 */ { UD_Ivucomiss, O_Vx, O_Wx, O_NONE, O_NONE, P_aso|P_rexr|P_rexx|P_rexb },
  /* 1436 */ { UD_Iud2, O_NONE, O_NONE, O_NONE, O_NONE, P_none },
  /* 1437 */ { UD_Iunpckhpd, O_V, O_W, O_NONE, O_NONE, P_aso|P_rexr|P_rexx|P_rexb },
  /* 1438 */ { UD_Ivunpckhpd, O_Vx, O_Hx, O_Wx, O_NONE, P_aso|P_rexr|P_rexx|P_rexb|P_vexl },
  /* 1439 */ { UD_Iunpckhps, O_V, O_W, O_NONE, O_NONE, P_aso|P_rexr|P_rexx|P_rexb },
  /* 1440 */ { UD_Ivunpckhps, O_Vx, O_Hx, O_Wx, O_NONE, P_aso|P_rexr|P_rexx|P_rexb },
  /* 1441 */ { UD_Iunpcklps, O_V, O_W, O_NONE, O_NONE, P_aso|P_rexr|P_rexx|P_rexb },
  /* 1442 */ { UD_Ivunpcklps, O_Vx, O_Hx, O_Wx, O_NONE, P_aso|P_rexr|P_rexx|P_rexb },
  /* 1443 */ { UD_Iunpcklpd, O_V, O_W, O_NONE, O_NONE, P_aso|P_rexr|P_rexx|P_rexb },
  /* 1444 */ { UD_Ivunpcklpd, O_Vx, O_Hx, O_Wx, O_NONE, P_aso|P_rexr|P_rexx|P_rexb|P_vexl },
  /* 1445 */ { UD_Iverr, O_Ew, O_NONE, O_NONE, O_NONE, P_aso|P_rexr|P_rexx|P_rexb },
  /* 1446 */ { UD_Iverw, O_Ew, O_NONE, O_NONE, O_NONE, P_aso|P_rexr|P_rexx|P_rexb },
  /* 1447 */ { UD_Ivmcall, O_NONE, O_NONE, O_NONE, O_NONE, P_none },
  /* 1448 */ { UD_Ivmclear, O_Mq, O_NONE, O_NONE, O_NONE, P_aso|P_rexr|P_rexx|P_rexb },
  /* 1449 */ { UD_Ivmxon, O_Mq, O_NONE, O_NONE, O_NONE, P_aso|P_rexr|P_rexx|P_rexb },
  /* 1450 */ { UD_Ivmptrld, O_Mq, O_NONE, O_NONE, O_NONE, P_aso|P_rexr|P_rexx|P_rexb },
  /* 1451 */ { UD_Ivmptrst, O_Mq, O_NONE, O_NONE, O_NONE, P_aso|P_rexr|P_rexx|P_rexb },
  /* 1452 */ { UD_Ivmlaunch, O_NONE, O_NONE, O_NONE, O_NONE, P_none },
  /* 1453 */ { UD_Ivmresume, O_NONE, O_NONE, O_NONE, O_NONE, P_none },
  /* 1454 */ { UD_Ivmxoff, O_NONE, O_NONE, O_NONE, O_NONE, P_none },
  /* 1455 */ { UD_Ivmread, O_Ey, O_Gy, O_NONE, O_NONE, P_aso|P_rexr|P_rexx|P_rexb|P_def64 },
  /* 1456 */ { UD_Ivmwrite, O_Gy, O_Ey, O_NONE, O_NONE, P_aso|P_rexr|P_rexx|P_rexb|P_def64 },
  /* 1457 */ { UD_Ivmrun, O_NONE, O_NONE, O_NONE, O_NONE, P_none },
  /* 1458 */ { UD_Ivmmcall, O_NONE, O_NONE, O_NONE, O_NONE, P_none },
  /* 1459 */ { UD_Ivmload, O_NONE, O_NONE, O_NONE, O_NONE, P_none },
  /* 1460 */ { UD_Ivmsave, O_NONE, O_NONE, O_NONE, O_NONE, P_none },
  /* 1461 */ { UD_Iwait, O_NONE, O_NONE, O_NONE, O_NONE, P_none },
  /* 1462 */ { UD_Iwbinvd, O_NONE, O_NONE, O_NONE, O_NONE, P_none },
  /* 1463 */ { UD_Iwrmsr, O_NONE, O_NONE, O_NONE, O_NONE, P_none },
  /* 1464 */ { UD_Ixadd, O_Eb, O_Gb, O_NONE, O_NONE, P_aso|P_oso|P_rexr|P_rexx|P_rexb },
  /* 1465 */ { UD_Ixadd, O_Ev, O_Gv, O_NONE, O_NONE, P_aso|P_oso|P_rexw|P_rexr|P_rexx|P_rexb },
  /* 1466 */ { UD_Ixchg, O_Eb, O_Gb, O_NONE, O_NONE, P_aso|P_rexr|P_rexx|P_rexb },
  /* 1467 */ { UD_Ixchg, O_Ev, O_Gv, O_NONE, O_NONE, P_aso|P_oso|P_rexw|P_rexr|P_rexx|P_rexb },
  /* 1468 */ { UD_Ixchg, O_R0v, O_rAX, O_NONE, O_NONE, P_oso|P_rexw|P_rexb },
  /* 1469 */ { UD_Ixchg, O_R1v, O_rAX, O_NONE, O_NONE, P_oso|P_rexw|P_rexb },
  /* 1470 */ { UD_Ixchg, O_R2v, O_rAX, O_NONE, O_NONE, P_oso|P_rexw|P_rexb },
  /* 1471 */ { UD_Ixchg, O_R3v, O_rAX, O_NONE, O_NONE, P_oso|P_rexw|P_rexb },
  /* 1472 */ { UD_Ixchg, O_R4v, O_rAX, O_NONE, O_NONE, P_oso|P_rexw|P_rexb },
  /* 1473 */ { UD_Ixchg, O_R5v, O_rAX, O_NONE, O_NONE, P_oso|P_rexw|P_rexb },
  /* 1474 */ { UD_Ixchg, O_R6v, O_rAX, O_NONE, O_NONE, P_oso|P_rexw|P_rexb },
  /* 1475 */ { UD_Ixchg, O_R7v, O_rAX, O_NONE, O_NONE, P_oso|P_rexw|P_rexb },
  /* 1476 */ { UD_Ixgetbv, O_NONE, O_NONE, O_NONE, O_NONE, P_none },
  /* 1477 */ { UD_Ixlatb, O_NONE, O_NONE, O_NONE, O_NONE, P_rexw|P_seg },
  /* 1478 */ { UD_Ixor, O_Eb, O_Gb, O_NONE, O_NONE, P_aso|P_rexr|P_rexx|P_rexb },
  /* 1479 */ { UD_Ixor, O_Ev, O_Gv, O_NONE, O_NONE, P_aso|P_oso|P_rexw|P_rexr|P_rexx|P_rexb },
  /* 1480 */ { UD_Ixor, O_Gb, O_Eb, O_NONE, O_NONE, P_aso|P_rexr|P_rexx|P_rexb },
  /* 1481 */ { UD_Ixor, O_Gv, O_Ev, O_NONE, O_NONE, P_aso|P_oso|P_rexw|P_rexr|P_rexx|P_rexb },
  /* 1482 */ { UD_Ixor, O_AL, O_Ib, O_NONE, O_NONE, P_none },
  /* 1483 */ { UD_Ixor, O_rAX, O_sIz, O_NONE, O_NONE, P_oso|P_rexw },
  /* 1484 */ { UD_Ixor, O_Eb, O_Ib, O_NONE, O_NONE, P_aso|P_rexr|P_rexx|P_rexb },
  /* 1485 */ { UD_Ixor, O_Ev, O_sIz, O_NONE, O_NONE, P_aso|P_oso|P_rexw|P_rexr|P_rexx|P_rexb },
  /* 1486 */ { UD_Ixor, O_Eb, O_Ib, O_NONE, O_NONE, P_aso|P_rexr|P_rexx|P_rexb|P_inv64 },
  /* 1487 */ { UD_Ixor, O_Ev, O_sIb, O_NONE, O_NONE, P_aso|P_oso|P_rexw|P_rexr|P_rexx|P_rexb },
  /* 1488 */ { UD_Ixorpd, O_V, O_W, O_NONE, O_NONE, P_aso|P_rexr|P_rexx|P_rexb },
  /* 1489 */ { UD_Ivxorpd, O_Vx, O_Hx, O_Wx, O_NONE, P_aso|P_rexr|P_rexx|P_rexb|P_vexl },
  /* 1490 */ { UD_Ixorps, O_V, O_W, O_NONE, O_NONE, P_aso|P_rexr|P_rexx|P_rexb },
  /* 1491 */ { UD_Ivxorps, O_Vx, O_Hx, O_Wx, O_NONE, P_aso|P_rexr|P_rexx|P_rexb },
  /* 1492 */ { UD_Ixcryptecb, O_NONE, O_NONE, O_NONE, O_NONE, P_none },
  /* 1493 */ { UD_Ixcryptcbc, O_NONE, O_NONE, O_NONE, O_NONE, P_none },
  /* 1494 */ { UD_Ixcryptctr, O_NONE, O_NONE, O_NONE, O_NONE, P_none },
  /* 1495 */ { UD_Ixcryptcfb, O_NONE, O_NONE, O_NONE, O_NONE, P_none },
  /* 1496 */ { UD_Ixcryptofb, O_NONE, O_NONE, O_NONE, O_NONE, P_none },
  /* 1497 */ { UD_Ixrstor, O_M, O_NONE, O_NONE, O_NONE, P_aso|P_rexw|P_rexr|P_rexx|P_rexb },
  /* 1498 */ { UD_Ixsave, O_M, O_NONE, O_NONE, O_NONE, P_aso|P_rexw|P_rexr|P_rexx|P_rexb },
  /* 1499 */ { UD_Ixsetbv, O_NONE, O_NONE, O_NONE, O_NONE, P_none },
  /* 1500 */ { UD_Ixsha1, O_NONE, O_NONE, O_NONE, O_NONE, P_none },
  /* 1501 */ { UD_Ixsha256, O_NONE, O_NONE, O_NONE, O_NONE, P_none },
  /* 1502 */ { UD_Ixstore, O_NONE, O_NONE, O_NONE, O_NONE, P_none },
  /* 1503 */ { UD_Ipclmulqdq, O_V, O_W, O_Ib, O_NONE, P_aso|P_rexr|P_rexx|P_rexb },
  /* 1504 */ { UD_Ivpclmulqdq, O_Vx, O_Hx, O_Wx, O_Ib, P_aso|P_rexr|P_rexx|P_rexb },
  /* 1505 */ { UD_Igetsec, O_NONE, O_NONE, O_NONE, O_NONE, P_none },
  /* 1506 */ { UD_Imovdqa, O_W, O_V, O_NONE, O_NONE, P_aso|P_rexr|P_rexx|P_rexb|P_vexl },
  /* 1507 */ { UD_Imovdqa, O_V, O_W, O_NONE, O_NONE, P_aso|P_rexr|P_rexx|P_rexb|P_vexl },
  /* 1508 */ { UD_Imaskmovdqu, O_V, O_U, O_NONE, O_NONE, P_aso|P_rexr|P_rexx|P_rexb },
  /* 1509 */ { UD_Ivmaskmovdqu, O_Vx, O_Ux, O_NONE, O_NONE, P_aso|P_rexr|P_rexx|P_rexb },
  /* 1510 */ { UD_Imovdq2q, O_P, O_U, O_NONE, O_NONE, P_aso|P_rexb },
  /* 1511 */ { UD_Imovdqu, O_V, O_W, O_NONE, O_NONE, P_aso|P_rexr|P_rexx|P_rexb },
  /* 1512 */ { UD_Ivmovdqu, O_Vx, O_Wx, O_NONE, O_NONE, P_aso|P_rexr|P_rexx|P_rexb|P_vexl },
  /* 1513 */ { UD_Imovdqu, O_W, O_V, O_NONE, O_NONE, P_aso|P_rexr|P_rexx|P_rexb },
  /* 1514 */ { UD_Imovq2dq, O_V, O_N, O_NONE, O_NONE, P_aso|P_rexr },
  /* 1515 */ { UD_Ipaddq, O_P, O_Q, O_NONE, O_NONE, P_aso|P_rexr|P_rexx|P_rexb },
  /* 1516 */ { UD_Ipaddq, O_V, O_W, O_NONE, O_NONE, P_aso|P_rexr|P_rexx|P_rexb },
  /* 1517 */ { UD_Ivpaddq, O_Vx, O_Hx, O_Wx, O_NONE, P_aso|P_rexr|P_rexx|P_rexb },
  /* 1518 */ { UD_Ipsubq, O_V, O_W, O_NONE, O_NONE, P_aso|P_rexr|P_rexx|P_rexb },
  /* 1519 */ { UD_Ivpsubq, O_Vx, O_Hx, O_Wx, O_NONE, P_aso|P_rexr|P_rexx|P_rexb },
  /* 1520 */ { UD_Ipsubq, O_P, O_Q, O_NONE, O_NONE, P_aso|P_rexr|P_rexx|P_rexb },
  /* 1521 */ { UD_Ipmuludq, O_P, O_Q, O_NONE, O_NONE, P_aso|P_rexr|P_rexx|P_rexb },
  /* 1522 */ { UD_Ipmuludq, O_V, O_W, O_NONE, O_NONE, P_aso|P_rexr|P_rexx|P_rexb },
  /* 1523 */ { UD_Ipshufhw, O_V, O_W, O_Ib, O_NONE, P_aso|P_rexr|P_rexx|P_rexb },
  /* 1524 */ { UD_Ivpshufhw, O_Vx, O_Wx, O_Ib, O_NONE, P_aso|P_rexr|P_rexx|P_rexb },
  /* 1525 */ { UD_Ipshuflw, O_V, O_W, O_Ib, O_NONE, P_aso|P_rexr|P_rexx|P_rexb },
  /* 1526 */ { UD_Ivpshuflw, O_Vx, O_Wx, O_Ib, O_NONE, P_aso|P_rexr|P_rexx|P_rexb },
  /* 1527 */ { UD_Ipshufd, O_V, O_W, O_Ib, O_NONE, P_aso|P_rexr|P_rexx|P_rexb },
  /* 1528 */ { UD_Ivpshufd, O_Vx, O_Wx, O_Ib, O_NONE, P_aso|P_rexr|P_rexx|P_rexb },
  /* 1529 */ { UD_Ipslldq, O_U, O_Ib, O_NONE, O_NONE, P_rexb },
  /* 1530 */ { UD_Ivpslldq, O_Hx, O_Ux, O_Ib, O_NONE, P_rexb },
  /* 1531 */ { UD_Ipsrldq, O_U, O_Ib, O_NONE, O_NONE, P_rexb },
  /* 1532 */ { UD_Ivpsrldq, O_Hx, O_Ux, O_Ib, O_NONE, P_rexb },
  /* 1533 */ { UD_Ipunpckhqdq, O_V, O_W, O_NONE, O_NONE, P_aso|P_rexr|P_rexx|P_rexb },
  /* 1534 */ { UD_Ivpunpckhqdq, O_Vx, O_Hx, O_Wx, O_NONE, P_aso|P_rexr|P_rexx|P_rexb },
  /* 1535 */ { UD_Ipunpcklqdq, O_V, O_W, O_NONE, O_NONE, P_aso|P_rexr|P_rexx|P_rexb },
  /* 1536 */ { UD_Ihaddpd, O_V, O_W, O_NONE, O_NONE, P_aso|P_rexr|P_rexx|P_rexb },
  /* 1537 */ { UD_Ivhaddpd, O_Vx, O_Hx, O_Wx, O_NONE, P_aso|P_rexr|P_rexx|P_rexb|P_vexl },
  /* 1538 */ { UD_Ihaddps, O_V, O_W, O_NONE, O_NONE, P_aso|P_rexr|P_rexx|P_rexb },
  /* 1539 */ { UD_Ivhaddps, O_Vx, O_Hx, O_Wx, O_NONE, P_aso|P_rexr|P_rexx|P_rexb|P_vexl },
  /* 1540 */ { UD_Ihsubpd, O_V, O_W, O_NONE, O_NONE, P_aso|P_rexr|P_rexx|P_rexb },
  /* 1541 */ { UD_Ivhsubpd, O_Vx, O_Hx, O_Wx, O_NONE, P_aso|P_rexr|P_rexx|P_rexb|P_vexl },
  /* 1542 */ { UD_Ihsubps, O_V, O_W, O_NONE, O_NONE, P_aso|P_rexr|P_rexx|P_rexb },
  /* 1543 */ { UD_Ivhsubps, O_Vx, O_Hx, O_Wx, O_NONE, P_aso|P_rexr|P_rexx|P_rexb|P_vexl },
  /* 1544 */ { UD_Iinsertps, O_V, O_Md, O_Ib, O_NONE, P_aso|P_rexr|P_rexw|P_rexx|P_rexb },
  /* 1545 */ { UD_Ivinsertps, O_Vx, O_Hx, O_Md, O_Ib, P_aso|P_rexr|P_rexw|P_rexx|P_rexb },
  /* 1546 */ { UD_Ilddqu, O_V, O_M, O_NONE, O_NONE, P_aso|P_rexr|P_rexx|P_rexb },
  /* 1547 */ { UD_Ivlddqu, O_Vx, O_M, O_NONE, O_NONE, P_aso|P_rexr|P_rexx|P_rexb|P_vexl },
  /* 1548 */ { UD_Imovddup, O_V, O_W, O_NONE, O_NONE, P_aso|P_rexr|P_rexx|P_rexb },
  /* 1549 */ { UD_Imovddup, O_V, O_W, O_NONE, O_NONE, P_aso|P_rexr|P_rexx|P_rexb },
  /* 1550 */ { UD_Imovshdup, O_V, O_W, O_NONE, O_NONE, P_aso|P_rexr|P_rexx|P_rexb },
  /* 1551 */ { UD_Ivmovshdup, O_Vx, O_Wx, O_NONE, O_NONE, P_aso|P_rexr|P_rexx|P_rexb|P_vexl },
  /* 1552 */ { UD_Imovshdup, O_V, O_W, O_NONE, O_NONE, P_aso|P_rexr|P_rexx|P_rexb },
  /* 1553 */ { UD_Ivmovshdup, O_Vx, O_Wx, O_NONE, O_NONE, P_aso|P_rexr|P_rexx|P_rexb|P_vexl },
  /* 1554 */ { UD_Imovsldup, O_V, O_W, O_NONE, O_NONE, P_aso|P_rexr|P_rexx|P_rexb },
  /* 1555 */ { UD_Ivmovsldup, O_Vx, O_Wx, O_NONE, O_NONE, P_aso|P_rexr|P_rexx|P_rexb|P_vexl },
  /* 1556 */ { UD_Imovsldup, O_V, O_W, O_NONE, O_NONE, P_aso|P_rexr|P_rexx|P_rexb },
  /* 1557 */ { UD_Ivmovsldup, O_Vx, O_Wx, O_NONE, O_NONE, P_aso|P_rexr|P_rexx|P_rexb|P_vexl },
  /* 1558 */ { UD_Ipabsb, O_P, O_Q, O_NONE, O_NONE, P_aso|P_rexr|P_rexx|P_rexb },
  /* 1559 */ { UD_Ipabsb, O_V, O_W, O_NONE, O_NONE, P_aso|P_rexr|P_rexx|P_rexb },
  /* 1560 */ { UD_Ivpabsb, O_Vx, O_Wx, O_NONE, O_NONE, P_aso|P_rexr|P_rexx|P_rexb|P_vexl },
  /* 1561 */ { UD_Ipabsw, O_P, O_Q, O_NONE, O_NONE, P_aso|P_rexr|P_rexx|P_rexb },
  /* 1562 */ { UD_Ipabsw, O_V, O_W, O_NONE, O_NONE, P_aso|P_rexr|P_rexx|P_rexb },
  /* 1563 */ { UD_Ivpabsw, O_Vx, O_Wx, O_NONE, O_NONE, P_aso|P_rexr|P_rexx|P_rexb|P_vexl },
  /* 1564 */ { UD_Ipabsd, O_P, O_Q, O_NONE, O_NONE, P_aso|P_rexr|P_rexx|P_rexb },
  /* 1565 */ { UD_Ipabsd, O_V, O_W, O_NONE, O_NONE, P_aso|P_rexr|P_rexx|P_rexb },
  /* 1566 */ { UD_Ivpabsd, O_Vx, O_Wx, O_NONE, O_NONE, P_aso|P_rexr|P_rexx|P_rexb|P_vexl },
  /* 1567 */ { UD_Ipshufb, O_P, O_Q, O_NONE, O_NONE, P_aso|P_rexr|P_rexx|P_rexb },
  /* 1568 */ { UD_Ipshufb, O_V, O_W, O_NONE, O_NONE, P_aso|P_rexr|P_rexx|P_rexb },
  /* 1569 */ { UD_Ivpshufb, O_Vx, O_Hx, O_Wx, O_NONE, P_aso|P_rexr|P_rexx|P_rexb },
  /* 1570 */ { UD_Iphaddw, O_P, O_Q, O_NONE, O_NONE, P_aso|P_rexr|P_rexx|P_rexb },
  /* 1571 */ { UD_Iphaddw, O_V, O_W, O_NONE, O_NONE, P_aso|P_rexr|P_rexx|P_rexb },
  /* 1572 */ { UD_Ivphaddw, O_Vx, O_Hx, O_Wx, O_NONE, P_aso|P_rexr|P_rexx|P_rexb },
  /* 1573 */ { UD_Iphaddd, O_P, O_Q, O_NONE, O_NONE, P_aso|P_rexr|P_rexx|P_rexb },
  /* 1574 */ { UD_Iphaddd, O_V, O_W, O_NONE, O_NONE, P_aso|P_rexr|P_rexx|P_rexb },
  /* 1575 */ { UD_Ivphaddd, O_Vx, O_Hx, O_Wx, O_NONE, P_aso|P_rexr|P_rexx|P_rexb },
  /* 1576 */ { UD_Iphaddsw, O_P, O_Q, O_NONE, O_NONE, P_aso|P_rexr|P_rexx|P_rexb },
  /* 1577 */ { UD_Iphaddsw, O_V, O_W, O_NONE, O_NONE, P_aso|P_rexr|P_rexx|P_rexb },
  /* 1578 */ { UD_Ivphaddsw, O_Vx, O_Hx, O_Wx, O_NONE, P_aso|P_rexr|P_rexx|P_rexb },
  /* 1579 */ { UD_Ipmaddubsw, O_P, O_Q, O_NONE, O_NONE, P_aso|P_rexr|P_rexx|P_rexb },
  /* 1580 */ { UD_Ipmaddubsw, O_V, O_W, O_NONE, O_NONE, P_aso|P_rexr|P_rexx|P_rexb },
  /* 1581 */ { UD_Ivpmaddubsw, O_Vx, O_Hx, O_Wx, O_NONE, P_aso|P_rexr|P_rexx|P_rexb },
  /* 1582 */ { UD_Iphsubw, O_P, O_Q, O_NONE, O_NONE, P_aso|P_rexr|P_rexx|P_rexb },
  /* 1583 */ { UD_Iphsubw, O_V, O_W, O_NONE, O_NONE, P_aso|P_rexr|P_rexx|P_rexb },
  /* 1584 */ { UD_Ivphsubw, O_Vx, O_Hx, O_Wx, O_NONE, P_aso|P_rexr|P_rexx|P_rexb },
  /* 1585 */ { UD_Iphsubd, O_P, O_Q, O_NONE, O_NONE, P_aso|P_rexr|P_rexx|P_rexb },
  /* 1586 */ { UD_Iphsubd, O_V, O_W, O_NONE, O_NONE, P_aso|P_rexr|P_rexx|P_rexb },
  /* 1587 */ { UD_Ivphsubd, O_Vx, O_Hx, O_Wx, O_NONE, P_aso|P_rexr|P_rexx|P_rexb },
  /* 1588 */ { UD_Iphsubsw, O_P, O_Q, O_NONE, O_NONE, P_aso|P_rexr|P_rexx|P_rexb },
  /* 1589 */ { UD_Iphsubsw, O_V, O_W, O_NONE, O_NONE, P_aso|P_rexr|P_rexx|P_rexb },
  /* 1590 */ { UD_Ivphsubsw, O_Vx, O_Hx, O_Wx, O_NONE, P_aso|P_rexr|P_rexx|P_rexb },
  /* 1591 */ { UD_Ipsignb, O_P, O_Q, O_NONE, O_NONE, P_aso|P_rexr|P_rexx|P_rexb },
  /* 1592 */ { UD_Ipsignb, O_V, O_W, O_NONE, O_NONE, P_aso|P_rexr|P_rexx|P_rexb },
  /* 1593 */ { UD_Ivpsignb, O_Vx, O_Hx, O_Wx, O_NONE, P_aso|P_rexr|P_rexx|P_rexb },
  /* 1594 */ { UD_Ipsignd, O_P, O_Q, O_NONE, O_NONE, P_aso|P_rexr|P_rexx|P_rexb },
  /* 1595 */ { UD_Ipsignd, O_V, O_W, O_NONE, O_NONE, P_aso|P_rexr|P_rexx|P_rexb },
  /* 1596 */ { UD_Ivpsignd, O_Vx, O_Hx, O_Wx, O_NONE, P_aso|P_rexr|P_rexx|P_rexb },
  /* 1597 */ { UD_Ipsignw, O_P, O_Q, O_NONE, O_NONE, P_aso|P_rexr|P_rexx|P_rexb },
  /* 1598 */ { UD_Ipsignw, O_V, O_W, O_NONE, O_NONE, P_aso|P_rexr|P_rexx|P_rexb },
  /* 1599 */ { UD_Ivpsignw, O_Vx, O_Hx, O_Wx, O_NONE, P_aso|P_rexr|P_rexx|P_rexb },
  /* 1600 */ { UD_Ipmulhrsw, O_P, O_Q, O_NONE, O_NONE, P_aso|P_rexr|P_rexx|P_rexb },
  /* 1601 */ { UD_Ipmulhrsw, O_V, O_W, O_NONE, O_NONE, P_aso|P_rexr|P_rexx|P_rexb },
  /* 1602 */ { UD_Ivpmulhrsw, O_Vx, O_Hx, O_Wx, O_NONE, P_aso|P_rexr|P_rexx|P_rexb },
  /* 1603 */ { UD_Ipalignr, O_P, O_Q, O_Ib, O_NONE, P_aso|P_rexr|P_rexx|P_rexb },
  /* 1604 */ { UD_Ipalignr, O_V, O_W, O_Ib, O_NONE, P_aso|P_rexr|P_rexx|P_rexb },
  /* 1605 */ { UD_Ivpalignr, O_Vx, O_Hx, O_Wx, O_Ib, P_aso|P_rexr|P_rexx|P_rexb },
  /* 1606 */ { UD_Ipblendvb, O_V, O_W, O_NONE, O_NONE, P_aso|P_rexr|P_rexx|P_rexb },
  /* 1607 */ { UD_Ipmuldq, O_V, O_W, O_NONE, O_NONE, P_aso|P_rexr|P_rexx|P_rexb },
  /* 1608 */ { UD_Ivpmuldq, O_Vx, O_Hx, O_Wx, O_NONE, P_aso|P_rexr|P_rexx|P_rexb },
  /* 1609 */ { UD_Ipminsb, O_V, O_W, O_NONE, O_NONE, P_aso|P_rexr|P_rexx|P_rexb },
  /* 1610 */ { UD_Ivpminsb, O_Vx, O_Hx, O_Wx, O_NONE, P_aso|P_rexr|P_rexx|P_rexb },
  /* 1611 */ { UD_Ipminsd, O_V, O_W, O_NONE, O_NONE, P_aso|P_rexr|P_rexx|P_rexb },
  /* 1612 */ { UD_Ivpminsd, O_Vx, O_Hx, O_Wx, O_NONE, P_aso|P_rexr|P_rexx|P_rexb },
  /* 1613 */ { UD_Ipminuw, O_V, O_W, O_NONE, O_NONE, P_aso|P_rexr|P_rexx|P_rexb },
  /* 1614 */ { UD_Ivpminuw, O_Vx, O_Hx, O_Wx, O_NONE, P_aso|P_rexr|P_rexx|P_rexb },
  /* 1615 */ { UD_Ipminud, O_V, O_W, O_NONE, O_NONE, P_aso|P_rexr|P_rexx|P_rexb },
  /* 1616 */ { UD_Ivpminud, O_Vx, O_Hx, O_Wx, O_NONE, P_aso|P_rexr|P_rexx|P_rexb },
  /* 1617 */ { UD_Ipmaxsb, O_V, O_W, O_NONE, O_NONE, P_aso|P_rexr|P_rexx|P_rexb },
  /* 1618 */ { UD_Ivpmaxsb, O_Vx, O_Hx, O_Wx, O_NONE, P_aso|P_rexr|P_rexx|P_rexb },
  /* 1619 */ { UD_Ipmaxsd, O_V, O_W, O_NONE, O_NONE, P_aso|P_rexr|P_rexx|P_rexb },
  /* 1620 */ { UD_Ivpmaxsd, O_Vx, O_Hx, O_Wx, O_NONE, P_aso|P_rexr|P_rexx|P_rexb },
  /* 1621 */ { UD_Ipmaxud, O_V, O_W, O_NONE, O_NONE, P_aso|P_rexr|P_rexx|P_rexb },
  /* 1622 */ { UD_Ivpmaxud, O_Vx, O_Hx, O_Wx, O_NONE, P_aso|P_rexr|P_rexx|P_rexb },
  /* 1623 */ { UD_Ipmaxuw, O_V, O_W, O_NONE, O_NONE, P_aso|P_rexr|P_rexx|P_rexb },
  /* 1624 */ { UD_Ivpmaxuw, O_Vx, O_Hx, O_Wx, O_NONE, P_aso|P_rexr|P_rexx|P_rexb },
  /* 1625 */ { UD_Ipmulld, O_V, O_W, O_NONE, O_NONE, P_aso|P_rexr|P_rexx|P_rexb },
  /* 1626 */ { UD_Ivpmulld, O_Vx, O_Hx, O_Wx, O_NONE, P_aso|P_rexr|P_rexx|P_rexb },
  /* 1627 */ { UD_Iphminposuw, O_V, O_W, O_NONE, O_NONE, P_aso|P_rexr|P_rexx|P_rexb },
  /* 1628 */ { UD_Ivphminposuw, O_Vx, O_Wx, O_NONE, O_NONE, P_aso|P_rexr|P_rexx|P_rexb },
  /* 1629 */ { UD_Iroundps, O_V, O_W, O_Ib, O_NONE, P_aso|P_rexr|P_rexx|P_rexb },
  /* 1630 */ { UD_Ivroundps, O_Vx, O_Wx, O_Ib, O_NONE, P_aso|P_rexr|P_rexx|P_rexb|P_vexl },
  /* 1631 */ { UD_Iroundpd, O_V, O_W, O_Ib, O_NONE, P_aso|P_rexr|P_rexx|P_rexb },
  /* 1632 */ { UD_Ivroundpd, O_Vx, O_Wx, O_Ib, O_NONE, P_aso|P_rexr|P_rexx|P_rexb|P_vexl },
  /* 1633 */ { UD_Iroundss, O_V, O_W, O_Ib, O_NONE, P_aso|P_rexr|P_rexx|P_rexb },
  /* 1634 */ { UD_Ivroundss, O_Vx, O_Hx, O_Wx, O_Ib, P_aso|P_rexr|P_rexx|P_rexb },
  /* 1635 */ { UD_Iroundsd, O_V, O_W, O_Ib, O_NONE, P_aso|P_rexr|P_rexx|P_rexb },
  /* 1636 */ { UD_Ivroundsd, O_Vx, O_Hx, O_Wx, O_Ib, P_aso|P_rexr|P_rexx|P_rexb },
  /* 1637 */ { UD_Iblendpd, O_V, O_W, O_Ib, O_NONE, P_aso|P_rexr|P_rexx|P_rexb },
  /* 1638 */ { UD_Ivblendpd, O_Vx, O_Hx, O_Wx, O_Ib, P_aso|P_rexr|P_rexx|P_rexb|P_vexl },
  /* 1639 */ { UD_Iblendps, O_V, O_W, O_Ib, O_NONE, P_aso|P_rexr|P_rexx|P_rexb },
  /* 1640 */ { UD_Ivblendps, O_Vx, O_Hx, O_Wx, O_Ib, P_aso|P_rexr|P_rexx|P_rexb },
  /* 1641 */ { UD_Iblendvpd, O_V, O_W, O_NONE, O_NONE, P_aso|P_rexr|P_rexx|P_rexb },
  /* 1642 */ { UD_Iblendvps, O_V, O_W, O_NONE, O_NONE, P_aso|P_rexr|P_rexx|P_rexb },
  /* 1643 */ { UD_Ibound, O_Gv, O_M, O_NONE, O_NONE, P_aso|P_oso },
  /* 1644 */ { UD_Ibsf, O_Gv, O_Ev, O_NONE, O_NONE, P_aso|P_oso|P_rexw|P_rexr|P_rexx|P_rexb },
  /* 1645 */ { UD_Ibsr, O_Gv, O_Ev, O_NONE, O_NONE, P_aso|P_oso|P_rexw|P_rexr|P_rexx|P_rexb },
  /* 1646 */ { UD_Ibswap, O_R0y, O_NONE, O_NONE, O_NONE, P_oso|P_rexw|P_rexb },
  /* 1647 */ { UD_Ibswap, O_R1y, O_NONE, O_NONE, O_NONE, P_oso|P_rexw|P_rexb },
  /* 1648 */ { UD_Ibswap, O_R2y, O_NONE, O_NONE, O_NONE, P_oso|P_rexw|P_rexb },
  /* 1649 */ { UD_Ibswap, O_R3y, O_NONE, O_NONE, O_NONE, P_oso|P_rexw|P_rexb },
  /* 1650 */ { UD_Ibswap, O_R4y, O_NONE, O_NONE, O_NONE, P_oso|P_rexw|P_rexb },
  /* 1651 */ { UD_Ibswap, O_R5y, O_NONE, O_NONE, O_NONE, P_oso|P_rexw|P_rexb },
  /* 1652 */ { UD_Ibswap, O_R6y, O_NONE, O_NONE, O_NONE, P_oso|P_rexw|P_rexb },
  /* 1653 */ { UD_Ibswap, O_R7y, O_NONE, O_NONE, O_NONE, P_oso|P_rexw|P_rexb },
  /* 1654 */ { UD_Ibt, O_Ev, O_Ib, O_NONE, O_NONE, P_aso|P_oso|P_rexw|P_rexr|P_rexx|P_rexb },
  /* 1655 */ { UD_Ibt, O_Ev, O_Gv, O_NONE, O_NONE, P_aso|P_oso|P_rexw|P_rexr|P_rexx|P_rexb },
  /* 1656 */ { UD_Ibtc, O_Ev, O_Gv, O_NONE, O_NONE, P_aso|P_oso|P_rexw|P_rexr|P_rexx|P_rexb },
  /* 1657 */ { UD_Ibtc, O_Ev, O_Ib, O_NONE, O_NONE, P_aso|P_oso|P_rexw|P_rexr|P_rexx|P_rexb },
  /* 1658 */ { UD_Ibtr, O_Ev, O_Gv, O_NONE, O_NONE, P_aso|P_oso|P_rexw|P_rexr|P_rexx|P_rexb },
  /* 1659 */ { UD_Ibtr, O_Ev, O_Ib, O_NONE, O_NONE, P_aso|P_oso|P_rexw|P_rexr|P_rexx|P_rexb },
  /* 1660 */ { UD_Ibts, O_Ev, O_Gv, O_NONE, O_NONE, P_aso|P_oso|P_rexw|P_rexr|P_rexx|P_rexb },
  /* 1661 */ { UD_Ibts, O_Ev, O_Ib, O_NONE, O_NONE, P_aso|P_oso|P_rexw|P_rexr|P_rexx|P_rexb },
  /* 1662 */ { UD_Ipblendw, O_V, O_W, O_Ib, O_NONE, P_aso|P_rexr|P_rexx|P_rexb },
  /* 1663 */ { UD_Ivpblendw, O_Vx, O_Hx, O_Wx, O_Ib, P_aso|P_rexr|P_rexx|P_rexb },
  /* 1664 */ { UD_Impsadbw, O_V, O_W, O_Ib, O_NONE, P_aso|P_rexr|P_rexx|P_rexb },
  /* 1665 */ { UD_Ivmpsadbw, O_Vx, O_Hx, O_Wx, O_Ib, P_aso|P_rexr|P_rexx|P_rexb|P_vexl },
  /* 1666 */ { UD_Imovntdqa, O_V, O_M, O_NONE, O_NONE, P_aso|P_rexr|P_rexw|P_rexx|P_rexb },
  /* 1667 */ { UD_Ivmovntdqa, O_Vx, O_M, O_NONE, O_NONE, P_aso|P_rexr|P_rexw|P_rexx|P_rexb|P_vexl },
  /* 1668 */ { UD_Ipackusdw, O_V, O_W, O_NONE, O_NONE, P_aso|P_rexr|P_rexw|P_rexx|P_rexb },
  /* 1669 */ { UD_Ivpackusdw, O_Vx, O_Hx, O_Wx, O_NONE, P_aso|P_rexr|P_rexw|P_rexx|P_rexb|P_vexl },
  /* 1670 */ { UD_Ipmovsxbw, O_V, O_MqU, O_NONE, O_NONE, P_aso|P_rexr|P_rexw|P_rexx|P_rexb },
  /* 1671 */ { UD_Ivpmovsxbw, O_Vx, O_MqU, O_NONE, O_NONE, P_aso|P_rexr|P_rexw|P_rexx|P_rexb },
  /* 1672 */ { UD_Ipmovsxbd, O_V, O_MdU, O_NONE, O_NONE, P_aso|P_rexr|P_rexw|P_rexx|P_rexb },
  /* 1673 */ { UD_Ivpmovsxbd, O_Vx, O_MdU, O_NONE, O_NONE, P_aso|P_rexr|P_rexw|P_rexx|P_rexb },
  /* 1674 */ { UD_Ipmovsxbq, O_V, O_MwU, O_NONE, O_NONE, P_aso|P_rexr|P_rexw|P_rexx|P_rexb },
  /* 1675 */ { UD_Ivpmovsxbq, O_Vx, O_MwU, O_NONE, O_NONE, P_aso|P_rexr|P_rexw|P_rexx|P_rexb },
  /* 1676 */ { UD_Ipmovsxwd, O_V, O_MqU, O_NONE, O_NONE, P_aso|P_rexr|P_rexw|P_rexx|P_rexb },
  /* 1677 */ { UD_Ivpmovsxwd, O_Vx, O_MqU, O_NONE, O_NONE, P_aso|P_rexr|P_rexw|P_rexx|P_rexb },
  /* 1678 */ { UD_Ipmovsxwq, O_V, O_MdU, O_NONE, O_NONE, P_aso|P_rexr|P_rexw|P_rexx|P_rexb },
  /* 1679 */ { UD_Ivpmovsxwq, O_Vx, O_MdU, O_NONE, O_NONE, P_aso|P_rexr|P_rexw|P_rexx|P_rexb },
  /* 1680 */ { UD_Ipmovsxdq, O_V, O_MqU, O_NONE, O_NONE, P_aso|P_rexr|P_rexw|P_rexx|P_rexb },
  /* 1681 */ { UD_Ipmovzxbw, O_V, O_MqU, O_NONE, O_NONE, P_aso|P_rexr|P_rexw|P_rexx|P_rexb },
  /* 1682 */ { UD_Ivpmovzxbw, O_Vx, O_MqU, O_NONE, O_NONE, P_aso|P_rexr|P_rexw|P_rexx|P_rexb },
  /* 1683 */ { UD_Ipmovzxbd, O_V, O_MdU, O_NONE, O_NONE, P_aso|P_rexr|P_rexw|P_rexx|P_rexb },
  /* 1684 */ { UD_Ivpmovzxbd, O_Vx, O_MdU, O_NONE, O_NONE, P_aso|P_rexr|P_rexw|P_rexx|P_rexb },
  /* 1685 */ { UD_Ipmovzxbq, O_V, O_MwU, O_NONE, O_NONE, P_aso|P_rexr|P_rexw|P_rexx|P_rexb },
  /* 1686 */ { UD_Ivpmovzxbq, O_Vx, O_MwU, O_NONE, O_NONE, P_aso|P_rexr|P_rexw|P_rexx|P_rexb },
  /* 1687 */ { UD_Ipmovzxwd, O_V, O_MqU, O_NONE, O_NONE, P_aso|P_rexr|P_rexw|P_rexx|P_rexb },
  /* 1688 */ { UD_Ivpmovzxwd, O_Vx, O_MqU, O_NONE, O_NONE, P_aso|P_rexr|P_rexw|P_rexx|P_rexb },
  /* 1689 */ { UD_Ipmovzxwq, O_V, O_MdU, O_NONE, O_NONE, P_aso|P_rexr|P_rexw|P_rexx|P_rexb },
  /* 1690 */ { UD_Ivpmovzxwq, O_Vx, O_MdU, O_NONE, O_NONE, P_aso|P_rexr|P_rexw|P_rexx|P_rexb },
  /* 1691 */ { UD_Ipmovzxdq, O_V, O_MqU, O_NONE, O_NONE, P_aso|P_rexr|P_rexw|P_rexx|P_rexb },
  /* 1692 */ { UD_Ivpmovzxdq, O_Vx, O_MqU, O_NONE, O_NONE, P_aso|P_rexr|P_rexw|P_rexx|P_rexb },
  /* 1693 */ { UD_Ipcmpeqq, O_V, O_W, O_NONE, O_NONE, P_aso|P_rexr|P_rexw|P_rexx|P_rexb },
  /* 1694 */ { UD_Ivpcmpeqq, O_Vx, O_Hx, O_Wx, O_NONE, P_aso|P_rexr|P_rexw|P_rexx|P_rexb },
  /* 1695 */ { UD_Ipopcnt, O_Gv, O_Ev, O_NONE, O_NONE, P_aso|P_oso|P_rexr|P_rexw|P_rexx|P_rexb },
  /* 1696 */ { UD_Iptest, O_V, O_W, O_NONE, O_NONE, P_aso|P_rexr|P_rexw|P_rexx|P_rexb },
  /* 1697 */ { UD_Ivptest, O_Vx, O_Wx, O_NONE, O_NONE, P_aso|P_rexr|P_rexw|P_rexx|P_rexb|P_vexl },
  /* 1698 */ { UD_Ipcmpestri, O_V, O_W, O_Ib, O_NONE, P_aso|P_rexr|P_rexw|P_rexx|P_rexb },
  /* 1699 */ { UD_Ivpcmpestri, O_Vx, O_Wx, O_Ib, O_NONE, P_aso|P_rexr|P_rexw|P_rexx|P_rexb },
  /* 1700 */ { UD_Ipcmpestrm, O_V, O_W, O_Ib, O_NONE, P_aso|P_rexr|P_rexw|P_rexx|P_rexb },
  /* 1701 */ { UD_Ivpcmpestrm, O_Vx, O_Wx, O_Ib, O_NONE, P_aso|P_rexr|P_rexw|P_rexx|P_rexb },
  /* 1702 */ { UD_Ipcmpgtq, O_V, O_W, O_NONE, O_NONE, P_aso|P_rexr|P_rexw|P_rexx|P_rexb },
  /* 1703 */ { UD_Ivpcmpgtq, O_Vx, O_Hx, O_Wx, O_NONE, P_aso|P_rexr|P_rexw|P_rexx|P_rexb },
  /* 1704 */ { UD_Ipcmpistri, O_V, O_W, O_Ib, O_NONE, P_aso|P_rexr|P_rexw|P_rexx|P_rexb },
  /* 1705 */ { UD_Ivpcmpistri, O_Vx, O_Wx, O_Ib, O_NONE, P_aso|P_rexr|P_rexw|P_rexx|P_rexb },
  /* 1706 */ { UD_Ipcmpistrm, O_V, O_W, O_Ib, O_NONE, P_aso|P_rexr|P_rexw|P_rexx|P_rexb },
  /* 1707 */ { UD_Ivpcmpistrm, O_Vx, O_Wx, O_Ib, O_NONE, P_aso|P_rexr|P_rexw|P_rexx|P_rexb },
  /* 1708 */ { UD_Imovbe, O_Gv, O_Mv, O_NONE, O_NONE, P_aso|P_oso|P_rexr|P_rexw|P_rexx|P_rexb },
  /* 1709 */ { UD_Imovbe, O_Mv, O_Gv, O_NONE, O_NONE, P_aso|P_oso|P_rexr|P_rexw|P_rexx|P_rexb },
  /* 1710 */ { UD_Icrc32, O_Gy, O_Eb, O_NONE, O_NONE, P_aso|P_oso|P_rexr|P_rexw|P_rexx|P_rexb },
  /* 1711 */ { UD_Icrc32, O_Gy, O_Ev, O_NONE, O_NONE, P_aso|P_oso|P_rexr|P_rexw|P_rexx|P_rexb },
  /* 1712 */ { UD_Ivbroadcastss, O_V, O_Md, O_NONE, O_NONE, P_aso|P_rexr|P_rexx|P_rexb|P_vexl },
  /* 1713 */ { UD_Ivbroadcastsd, O_Vqq, O_Mq, O_NONE, O_NONE, P_aso|P_rexr|P_rexx|P_rexb|P_vexl },
  /* 1714 */ { UD_Ivextractf128, O_Wdq, O_Vqq, O_Ib, O_NONE, P_aso|P_rexr|P_rexx|P_rexb|P_vexl },
  /* 1715 */ { UD_Ivinsertf128, O_Vqq, O_Hqq, O_Wdq, O_Ib, P_aso|P_rexr|P_rexx|P_rexb|P_vexl },
  /* 1716 */ { UD_Ivmaskmovps, O_V, O_H, O_M, O_NONE, P_aso|P_rexr|P_rexx|P_rexb|P_vexl },
  /* 1717 */ { UD_Ivmaskmovps, O_M, O_H, O_V, O_NONE, P_aso|P_rexr|P_rexx|P_rexb|P_vexl },
  /* 1718 */ { UD_Ivmaskmovpd, O_V, O_H, O_M, O_NONE, P_aso|P_rexr|P_rexx|P_rexb|P_vexl },
  /* 1719 */ { UD_Ivmaskmovpd, O_M, O_H, O_V, O_NONE, P_aso|P_rexr|P_rexx|P_rexb|P_vexl },
  /* 1720 */ { UD_Ivpermilpd, O_Vx, O_Hx, O_Wx, O_NONE, P_aso|P_rexr|P_rexx|P_rexb|P_vexl },
  /* 1721 */ { UD_Ivpermilpd, O_V, O_W, O_Ib, O_NONE, P_aso|P_rexr|P_rexx|P_rexb|P_vexl },
  /* 1722 */ { UD_Ivpermilps, O_Vx, O_Hx, O_Wx, O_NONE, P_aso|P_rexr|P_rexx|P_rexb|P_vexl },
  /* 1723 */ { UD_Ivpermilps, O_Vx, O_Wx, O_Ib, O_NONE, P_aso|P_rexr|P_rexx|P_rexb|P_vexl },
  /* 1724 */ { UD_Ivperm2f128, O_Vqq, O_Hqq, O_Wqq, O_Ib, P_aso|P_rexr|P_rexx|P_rexb|P_vexl },
  /* 1725 */ { UD_Ivtestps, O_Vx, O_Wx, O_NONE, O_NONE, P_aso|P_rexr|P_rexx|P_rexb|P_vexl },
  /* 1726 */ { UD_Ivtestpd, O_Vx, O_Wx, O_NONE, O_NONE, P_aso|P_rexr|P_rexx|P_rexb|P_vexl },
  /* 1727 */ { UD_Ivzeroupper, O_NONE, O_NONE, O_NONE, O_NONE, P_none },
  /* 1728 */ { UD_Ivzeroall, O_NONE, O_NONE, O_NONE, O_NONE, P_none },
  /* 1729 */ { UD_Ivblendvpd, O_Vx, O_Hx, O_Wx, O_Lx, P_aso|P_rexr|P_rexx|P_rexb|P_vexl },
  /* 1730 */ { UD_Ivblendvps, O_Vx, O_Hx, O_Wx, O_Lx, P_aso|P_rexr|P_rexx|P_rexb|P_vexl },
  /* 1731 */ { UD_Ivmovsd, O_V, O_H, O_U, O_NONE, P_aso|P_rexr|P_rexx|P_rexb },
  /* 1732 */ { UD_Ivmovsd, O_V, O_Mq, O_NONE, O_NONE, P_aso|P_rexr|P_rexx|P_rexb },
  /* 1733 */ { UD_Ivmovsd, O_U, O_H, O_V, O_NONE, P_aso|P_rexr|P_rexx|P_rexb },
  /* 1734 */ { UD_Ivmovsd, O_Mq, O_V, O_NONE, O_NONE, P_aso|P_rexr|P_rexx|P_rexb },
  /* 1735 */ { UD_Ivmovss, O_V, O_H, O_U, O_NONE, P_aso|P_rexr|P_rexx|P_rexb },
  /* 1736 */ { UD_Ivmovss, O_V, O_Md, O_NONE, O_NONE, P_aso|P_rexr|P_rexx|P_rexb },
  /* 1737 */ { UD_Ivmovss, O_U, O_H, O_V, O_NONE, P_aso|P_rexr|P_rexx|P_rexb },
  /* 1738 */ { UD_Ivmovss, O_Md, O_V, O_NONE, O_NONE, P_aso|P_rexr|P_rexx|P_rexb },
  /* 1739 */ { UD_Ivpblendvb, O_V, O_H, O_W, O_L, P_aso|P_rexr|P_rexx|P_rexb },
  /* 1740 */ { UD_Ivpsllw, O_V, O_H, O_W, O_NONE, P_aso|P_rexr|P_rexx|P_rexb },
  /* 1741 */ { UD_Ivpsllw, O_H, O_V, O_W, O_NONE, P_aso|P_rexr|P_rexx|P_rexb },
  /* 1742 */ { UD_Ivpslld, O_V, O_H, O_W, O_NONE, P_aso|P_rexr|P_rexx|P_rexb },
  /* 1743 */ { UD_Ivpslld, O_H, O_V, O_W, O_NONE, P_aso|P_rexr|P_rexx|P_rexb },
  /* 1744 */ { UD_Ivpsllq, O_V, O_H, O_W, O_NONE, P_aso|P_rexr|P_rexx|P_rexb },
  /* 1745 */ { UD_Ivpsllq, O_H, O_V, O_W, O_NONE, P_aso|P_rexr|P_rexx|P_rexb },
};
